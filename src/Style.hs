...
getDictAndFns :: (RealFloat a, Floating a, Real a, Show a, Ord a) =>
...
procBlock :: (RealFloat a, Floating a, Real a, Show a, Ord a) =>
    (StyDict, [(ObjFnOn a, Weight a, [Name], [a])], [(ConstrFnOn a, Weight a, [Name], [a])])
    -> Block
    -> (StyDict, [(ObjFnOn a, Weight a, [Name], [a])], [(ConstrFnOn a, Weight a, [Name], [a])])
...
procConstrFn :: (RealFloat a, Floating a, Real a, Show a, Ord a) =>
...
procObjFn :: (RealFloat a, Floating a, Real a, Show a, Ord a) =>
