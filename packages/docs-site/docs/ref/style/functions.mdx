...
▸ **collinearUnordered**(`c1`, `c2`, `c3`): `VarAD`
...
▸ **disjointScalar**(`c`, `left`, `right`): `VarAD`
...
▸ `Static` **atDist**(`__namedParameters`, `__namedParameters`, `distance`): `VarAD`
...
▸ `Static` **contains**(`__namedParameters`, `__namedParameters`, `padding?`): `VarAD`
...
▸ `Static` **contains1D**(`__namedParameters`, `__namedParameters`): `VarAD`
...
▸ `Static` **disjoint**(`__namedParameters`, `__namedParameters`, `padding?`): `VarAD`
...
▸ `Static` **disjointIntervals**(`__namedParameters`, `__namedParameters`): `VarAD`
...
▸ `Static` **greaterThan**(`x`, `y`, `padding?`): `VarAD`
...
▸ `Static` **greaterThanSq**(`x`, `y`): `VarAD`
...
▸ `Static` **lessThan**(`x`, `y`, `padding?`): `VarAD`
...
▸ `Static` **maxSize**(`__namedParameters`, `limit`): `VarAD`
...
▸ `Static` **minSize**(`__namedParameters`, `limit?`): `VarAD`
...
▸ `Static` **onCanvas**(`__namedParameters`, `canvasWidth`, `canvasHeight`): `VarAD`
...
▸ `Static` **overlapping**(`__namedParameters`, `__namedParameters`, `padding?`): `VarAD`
...
▸ `Static` **ptCircleIntersect**(`p`, `__namedParameters`): `VarAD`
...
▸ `Static` **smallerThan**(`__namedParameters`, `__namedParameters`, `relativePadding?`): `VarAD`
...
▸ `Static` **touching**(`__namedParameters`, `__namedParameters`, `padding?`): `VarAD`
...
▸ `Static` **above**(`__namedParameters`, `__namedParameters`, `offset?`): `VarAD`
...
▸ `Static` **below**(`__namedParameters`, `__namedParameters`, `offset?`): `VarAD`
...
▸ `Static` **centerArrow**(`__namedParameters`, `__namedParameters`, `__namedParameters`): `VarAD`
...
▸ `Static` **centerLabel**(`__namedParameters`, `__namedParameters`, `w`, `padding?`): `VarAD`
...
▸ `Static` **centerLabelAbove**(`__namedParameters`, `__namedParameters`, `w`): `VarAD`
...
▸ `Static` **leftwards**(`__namedParameters`, `__namedParameters`, `offset?`): `VarAD`
...
▸ `Static` **near**(`__namedParameters`, `__namedParameters`, `offset?`): `VarAD`
...
▸ `Static` **nearPt**(`__namedParameters`, `x`, `y`): `VarAD`
...
▸ `Static` **nonDegenerateAngle**(`__namedParameters`, `__namedParameters`, `__namedParameters`, `strength?`, `range?`): `VarAD`
...
▸ `Static` **pointLineDist**(`point`, `__namedParameters`, `padding`): `VarAD`
...
▸ `Static` **repel**(`__namedParameters`, `__namedParameters`, `weight?`): `VarAD`
...
▸ `Static` **repelPt**(`weight`, `a`, `b`): `VarAD`
...
▸ `Static` **rightwards**(`__namedParameters`, `__namedParameters`, `offset?`): `VarAD`
...
▸ `Static` **sameCenter**(`__namedParameters`, `__namedParameters`): `VarAD`
...
▸ `Static` **MathE**(`_context`): `IFloatV`<`VarAD`\>
...
▸ `Static` **MathPI**(`_context`): `IFloatV`<`VarAD`\>
...
▸ `Static` **abs**(`_context`, `x`): `IFloatV`<`VarAD`\>
...
▸ `Static` **acos**(`_context`, `x`): `IFloatV`<`VarAD`\>
...
▸ `Static` **acosh**(`_context`, `x`): `IFloatV`<`VarAD`\>
...
▸ `Static` **angleBetween**(`_context`, `u`, `v`): `IFloatV`<`VarAD`\>
...
▸ `Static` **angleFrom**(`_context`, `u`, `v`): `IFloatV`<`VarAD`\>
...
▸ `Static` **angleOf**(`_context`, `v`): `IFloatV`<`VarAD`\>
...
▸ `Static` **arc**(`_context`, `pathType`, `start`, `end`, `radius`, `rotation`, `largeArc`, `arcSweep`): `IPathDataV`<`VarAD`\>
...
▸ `Static` **arcSweepFlag**(`_context`, `__namedParameters`, `start`, `end`): `IFloatV`<`VarAD`\>
...
▸ `Static` **asin**(`_context`, `x`): `IFloatV`<`VarAD`\>
...
▸ `Static` **asinh**(`_context`, `x`): `IFloatV`<`VarAD`\>
...
▸ `Static` **atan**(`_context`, `x`): `IFloatV`<`VarAD`\>
...
▸ `Static` **atan2**(`_context`, `x`, `y`): `IFloatV`<`VarAD`\>
...
▸ `Static` **atanh**(`_context`, `x`): `IFloatV`<`VarAD`\>
...
▸ `Static` **average**(`_context`, `xs`): `IFloatV`<`VarAD`\>
...
▸ `Static` **average2**(`_context`, `x`, `y`): `IFloatV`<`VarAD`\>
...
▸ `Static` **barycenter**(`_context`, `a`, `b`, `c`): `IVectorV`<`VarAD`\>
...
▸ `Static` **cbrt**(`_context`, `x`): `IFloatV`<`VarAD`\>
...
▸ `Static` **ceil**(`_context`, `x`): `IFloatV`<`VarAD`\>
...
▸ `Static` **chevron**(`_context`, `__namedParameters`, `padding`, `ticks`): `IPtListV`<`VarAD`\>
...
▸ `Static` **circumcenter**(`_context`, `p`, `q`, `r`): `IVectorV`<`VarAD`\>
...
▸ `Static` **circumradius**(`_context`, `p`, `q`, `r`): `IFloatV`<`VarAD`\>
...
▸ `Static` **cos**(`_context`, `x`): `IFloatV`<`VarAD`\>
...
▸ `Static` **cosh**(`_context`, `x`): `IFloatV`<`VarAD`\>
...
▸ `Static` **cross2D**(`_context`, `u`, `v`): `IFloatV`<`VarAD`\>
...
▸ `Static` **cubicCurveFromPoints**(`_context`, `pathType`, `pts`): `IPathDataV`<`VarAD`\>
...
▸ `Static` **dot**(`_context`, `v`, `w`): `IFloatV`<`VarAD`\>
...
▸ `Static` **exp**(`_context`, `x`): `IFloatV`<`VarAD`\>
...
▸ `Static` **expm1**(`_context`, `x`): `IFloatV`<`VarAD`\>
...
▸ `Static` **floor**(`_context`, `x`): `IFloatV`<`VarAD`\>
...
▸ `Static` **furthestFrom**(`pts`, `candidates`): `VarAD`[]
...
▸ `Static` **hsva**(`_context`, `h`, `s`, `v`, `a`): `IColorV`<`VarAD`\>
...
▸ `Static` **incenter**(`_context`, `p`, `q`, `r`): `IVectorV`<`VarAD`\>
...
▸ `Static` **innerPointOffset**(`_context`, `pt1`, `pt2`, `pt3`, `padding`): `IVectorV`<`VarAD`\>
...
▸ `Static` **inradius**(`_context`, `p`, `q`, `r`): `IFloatV`<`VarAD`\>
...
▸ `Static` **intersectingSideSize**(`_context`, `start`, `end`, `__namedParameters`): `IFloatV`<`VarAD`\>
...
▸ `Static` **len**(`_context`, `__namedParameters`): `IFloatV`<`VarAD`\>
...
▸ `Static` **lineLength**(`_context`, `__namedParameters`): `IFloatV`<`VarAD`\>
...
▸ `Static` **lineLineIntersection**(`_context`, `a0`, `a1`, `b0`, `b1`): `IVectorV`<`VarAD`\>
...
▸ `Static` **log**(`_context`, `x`): `IFloatV`<`VarAD`\>
...
▸ `Static` **log10**(`_context`, `x`): `IFloatV`<`VarAD`\>
...
▸ `Static` **log1p**(`_context`, `x`): `IFloatV`<`VarAD`\>
...
▸ `Static` **log2**(`_context`, `x`): `IFloatV`<`VarAD`\>
...
▸ `Static` **makePath**(`_context`, `start`, `end`, `curveHeight`, `padding`): `IPathDataV`<`VarAD`\>
...
▸ `Static` **max**(`_context`, `x`, `y`): `IFloatV`<`VarAD`\>
...
▸ `Static` **midpoint**(`_context`, `start`, `end`): `IVectorV`<`VarAD`\>
...
▸ `Static` **midpointOffset**(`_context`, `__namedParameters`, `padding`): `ITupV`<`VarAD`\>
...
▸ `Static` **min**(`_context`, `x`, `y`): `IFloatV`<`VarAD`\>
...
▸ `Static` **mul**(`_context`, `m`, `v`): `IVectorV`<`VarAD`\>
...
▸ `Static` **norm**(`_context`, `v`): `IFloatV`<`VarAD`\>
...
▸ `Static` **normalize**(`_context`, `v`): `IVectorV`<`VarAD`\>
...
▸ `Static` **normsq**(`_context`, `v`): `IFloatV`<`VarAD`\>
...
▸ `Static` **orientedSquare**(`_context`, `__namedParameters`, `__namedParameters`, `intersection`, `len`): `IPathDataV`<`VarAD`\>
...
▸ `Static` **pathFromPoints**(`_context`, `pathType`, `pts`): `IPathDataV`<`VarAD`\>
...
▸ `Static` **pow**(`_context`, `x`, `y`): `IFloatV`<`VarAD`\>
...
▸ `Static` **ptOnLine**(`_context`, `p1`, `p2`, `r`): `IVectorV`<`VarAD`\>
...
▸ `Static` **quadraticCurveFromPoints**(`_context`, `pathType`, `pts`): `IPathDataV`<`VarAD`\>
...
▸ `Static` **rgba**(`_context`, `r`, `g`, `b`, `a`): `IColorV`<`VarAD`\>
...
▸ `Static` **rot90v**(`__namedParameters`): `VarAD`[]
...
▸ `Static` **round**(`_context`, `x`): `IFloatV`<`VarAD`\>
...
▸ `Static` **sampleColor**(`context`, `alpha`, `colorType`): `IColorV`<`VarAD`\>
...
▸ `Static` **selectColor**(`_context`, `color1`, `color2`, `level`): `IColorV`<`VarAD`\>
...
▸ `Static` **setOpacity**(`_context`, `color`, `frac`): `IColorV`<`VarAD`\>
...
▸ `Static` **sign**(`_context`, `x`): `IFloatV`<`VarAD`\>
...
▸ `Static` **sin**(`_context`, `x`): `IFloatV`<`VarAD`\>
...
▸ `Static` **sinh**(`_context`, `x`): `IFloatV`<`VarAD`\>
...
▸ `Static` **sqr**(`_context`, `x`): `IFloatV`<`VarAD`\>
...
▸ `Static` **sqrt**(`_context`, `x`): `IFloatV`<`VarAD`\>
...
▸ `Static` **tan**(`_context`, `x`): `IFloatV`<`VarAD`\>
...
▸ `Static` **tanh**(`_context`, `x`): `IFloatV`<`VarAD`\>
...
▸ `Static` **tickPlacement**(`padding`, `numPts`, `multiplier?`): `VarAD`[]
...
▸ `Static` **ticksOnLine**(`_context`, `pt1`, `pt2`, `spacing`, `numTicks`, `tickLength`): `IPathDataV`<`VarAD`\>
...
▸ `Static` **toDegrees**(`_context`, `theta`): `IFloatV`<`VarAD`\>
...
▸ `Static` **toRadians**(`_context`, `theta`): `IFloatV`<`VarAD`\>
...
▸ `Static` **triangle**(`_context`, `__namedParameters`, `__namedParameters`, `__namedParameters`): `IPathDataV`<`VarAD`\>
...
▸ `Static` **trunc**(`_context`, `x`): `IFloatV`<`VarAD`\>
...
▸ `Static` **unit**(`_context`, `v`): `IVectorV`<`VarAD`\>
...
▸ `Static` **unitMark**(`_context`, `__namedParameters`, `__namedParameters`, `t`, `padding`, `barSize`): `IPtListV`<`VarAD`\>
...
▸ `Static` **unitMark2**(`_context`, `__namedParameters`, `t`, `padding`, `size`): `IPtListV`<`VarAD`\>
...
▸ `Static` **vdist**(`_context`, `v`, `w`): `IFloatV`<`VarAD`\>
...
▸ `Static` **vdistsq**(`_context`, `v`, `w`): `IFloatV`<`VarAD`\>
...
▸ `Static` **vmul**(`_context`, `s`, `v`): `IVectorV`<`VarAD`\>
...
▸ `Static` **wedge**(`_context`, `center`, `start`, `end`, `radius`, `rotation`, `largeArc`, `arcSweep`): `IPathDataV`<`VarAD`\>
