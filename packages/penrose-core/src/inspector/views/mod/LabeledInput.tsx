                  ...
                  <React.Fragment key={"S" + index + "pt" + subindex}>
                    ...
                    >
                      <input
                        ...
                        value={_.round(pt.contents[0] as number)}
                      />
                      {this.makeSubLabel(
                        xid,
                        xspan,
                    ...
                    >
                      <input
                        ...
                        value={_.round(pt.contents[1] as number)}
                      />
                      {this.makeSubLabel(
                        yid,
                        yspan,
      ...
      <React.Fragment>
        ...
        <div className="sublabinput" style={{ display: "inline-block" }}>
          <input
            ...
            min="0"
            max="100"
            value={_.round(100 * this.props.eValue.contents.contents[3])}
