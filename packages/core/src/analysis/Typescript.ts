...
/**
 * Retrieves the source code for local, inner functions.
 *
 * @param src Source code of outer function
 * @param ast AST of outer function (optional)
 * @returns Map of inner function name to inner source code.
 */
