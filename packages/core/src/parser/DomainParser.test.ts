...
import { validateDomain } from "../compiler/Domain.js";
import { parser as lezerParser } from "../parser/domainParser.js";
...
describe("Validation", () => {
  test("running", () => {
    // console.log(
    validateDomain(lezerParser.parse(geometryDomain), geometryDomain);
    // );
  });
});
