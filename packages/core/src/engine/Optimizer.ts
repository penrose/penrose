...
const minimize = (
    ...
    let preconditionedGradDotProduct = 0.0;
    let i = 0;
    ...
    while (i < numSteps) {
        ...
        preconditionedGradDotProduct = dot(gradfxs, gradfxsPreconditioned);

        if (BREAK_EARLY && unconstrainedConverged2(preconditionedGradDotProduct)) {
        ...
        if (DEBUG_GRAD_DESCENT) {
            ...
            log.info("<grad, precnditioned grad>:", preconditionedGradDotProduct);
    ...
    return {
        xs,
        energyVal: fxs,
        normGrad: preconditionedGradDotProduct,
        newLbfgsInfo,
        gradient: gradfxs,
        gradientPreconditioned,
    };
