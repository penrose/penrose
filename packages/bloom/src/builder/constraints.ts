...
const constraints = {
     ...
     */
    equal: (x: Num, y: Num) =>
      constrDict.equal.body(x, y).value,
     ...
     */
    lessThan: (x: Num, y: Num, padding: number = 0) =>
     ...
     * @param padding Padding (default: 0)
     */
    greaterThan: (x: Num, y: Num, padding: number = 0) =>
     ...
     */
    contains1D: (interval1: Vec2, interval2: Vec2) =>
     ...
     */
    disjointScalar: (c: Num, left: Num, right: Num) =>
     ...
     * @param r Third point
     */
    perpendicular: (q: VecN, p: VecN, r: VecN) =>
     ...
     */
    collinear: (c1: VecN, c2: VecN, c3: VecN) =>
     ...
     * @param c3 Third point
     */
    collinearOrdered: (c1: VecN, c2: VecN, c3: VecN) =>
     ...
     */
    onCanvas: (shape: Shape, canvasWidth: Num, canvasHeight: Num) =>
      constrDict.onCanvas.body(toPenroseShape(shape), canvasWidth, canvasHeight).value,
     ...
     */
    overlapping: (s1: Shape, s2: Shape, overlap: Num = 0) =>
      constrDict.overlapping.body(toPenroseShape(s1), toPenroseShape(s2), overlap).value,
     ...
     */
    overlappingEllipses: (c1: Vec2, rx1: Num, ry1: Num, c2: Vec2, rx2: Num, ry2: Num, overlap: Num = 0) =>
      constrDict.overlappingEllipses.body(c1, rx1, ry1, c2, rx2, ry2, overlap).value,
     ...
     * @param overlap The least amount of overlap (default: 0)
     */
    overlappingCircleEllipse: (c1: Vec2, r1: Num, c2: Vec2, rx2: Num, ry2: Num, overlap: Num = 0) =>
     ...
     * @param padding Padding (default: 0)
     */
    disjoint: (s1: Shape, s2: Shape, padding: Num = 0) =>
      constrDict.disjoint.body(toPenroseShape(s1), toPenroseShape(s2), padding).value,
     ...
     * @param padding Padding (default: 0)
     */
    touching: (s1: Shape, s2: Shape, padding: Num = 0) =>
      constrDict.touching.body(toPenroseShape(s1), toPenroseShape(s2), padding).value,
     ...
     * @param padding Padding (default: 0)
     */
    contains: (s1: Shape, s2: Shape, padding: Num = 0) =>
      constrDict.contains.body(toPenroseShape(s1), toPenroseShape(s2), padding).value,
     ...
     */
    containsCircles: (c1: Vec2, r1: Num, c2: Vec2, r2: Num, padding: Num = 0) =>
     ...
     */
    containsPolys: (pts1: Vec2[], pts2: Vec2[], padding: Num = 0) =>
     ...
     */
    containsPolyCircle: (pts: Vec2[], c: Vec2, r: Num, padding: Num = 0) =>
     ...
     */
    containsPolyPoint: (pts: Vec2[], pt: Vec2, padding: Num = 0) =>
     ...
     * @param padding Margin between the polygon and the point (default: 0)
     */
    containsCirclePoint: (c: Vec2, r: Num, pt: Vec2, padding: Num = 0) =>
     ...
     * @param padding Margin between the polygon and the point (default: 0)
     */
    containsCirclePoly: (c: Vec2, r: Num, pts: Vec2[], padding: Num = 0) =>
     ...
     * @param padding Margin between the polygon and the point (default: 0)
     */
    containsCircleRect: (c: Vec2, r: Num, rect: Vec2[], padding: Num = 0) =>
     ...
     * @param padding Margin between the polygon and the point (default: 0)
     */
    containsRectCircle: (rect: Vec2[], c: Vec2, r: Num, padding: Num = 0) =>
     ...
     * @param padding Margin between the polygon and the point (default: 0)
     */
    containsRects: (rect1: Vec2[], rect2: Vec2[], padding: Num = 0) =>
     ...
     */
    distributeHorizontally: (shapes: Shape[], padding: Num = 0) =>
      constrDict.distributeHorizontally.body(shapes.map((shape) => toPenroseShape(shape)), padding).value,
     ...
     * @param padding Margin between bounding boxes of shapes (default: 0)
     */
    distributeVertically: (shapes: Shape[], padding: Num = 0) =>
      constrDict.distributeVertically.body(shapes.map((shape) => toPenroseShape(shape)), padding).value,
