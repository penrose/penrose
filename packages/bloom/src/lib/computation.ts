...
const computation = {
   ...
   * @returns expm1(x)
   */
  expm1: (x: Num): Num => compDict.expm1.body(context, x).value.contents,
   ...
   * @returns floor(x)
   */
  floor: (x: Num): Num => compDict.floor.body(context, x).value.contents,
   ...
   * @returns log(x)
   */
  log: (x: Num): Num => compDict.log.body(context, x).value.contents,
   ...
   * @returns log2(x)
   */
  log2: (x: Num): Num => compDict.log2.body(context, x).value.contents,
   ...
   * @returns log10(x)
   */
  log10: (x: Num): Num => compDict.log10.body(context, x).value.contents,
   ...
   * @returns log1p(x)
   */
  log1p: (x: Num): Num => compDict.log1p.body(context, x).value.contents,
   ...
   * @returns pow(x,y)
   */
  pow: (x: Num, y: Num): Num => compDict.pow.body(context, x, y).value.contents,
   ...
   * @returns round(x)
   */
  round: (x: Num): Num => compDict.round.body(context, x).value.contents,
   ...
   * @returns sign(x)
   */
  sign: (x: Num): Num => compDict.sign.body(context, x).value.contents,
   ...
   * @returns sin(x)
   */
  sin: (x: Num): Num => compDict.sin.body(context, x).value.contents,
   ...
   * @returns sinh(x)
   */
  sinh: (x: Num): Num => compDict.sinh.body(context, x).value.contents,
   ...
   * @returns tan(x)
   */
  tan: (x: Num): Num => compDict.tan.body(context, x).value.contents,
   ...
   * @returns tanh(x)
   */
  tanh: (x: Num): Num => compDict.tanh.body(context, x).value.contents,
   ...
   * @returns trunc(x)
   */
  trunc: (x: Num): Num => compDict.trunc.body(context, x).value.contents,
   ...
   */
  sum: (xs: VecN): Num => compDict.sum.body(context, xs).value.contents,
   ...
   */
  maxList: (xs: VecN): Num => compDict.maxList.body(context, xs).value.contents,
   ...
   */
  minList: (xs: VecN): Num => compDict.minList.body(context, xs).value.contents,
   ...
   */
  count: (xs: VecN): Num => compDict.count.body(context, xs).value.contents,
   ...
   * @returns Trace of A
   */
  trace: (A: Num[][]): Num => compDict.trace.body(context, A).value.contents,
   ...
   */
  outerProduct: (v: VecN, w: VecN): Num[][] =>
   ...
   */
  matrix: (a: Num, b: Num, c: Num, d: Num, e: Num, f: Num): Num[][] =>
    compDict.matrix.body(context, a, b, c, d, e, f).value.contents,
   ...
   */
  rotate: (theta: Num, x: Num = 0, y: Num = 0): Num[][] =>
   ...
   */
  rotate3dh: (theta: Num, v: VecN): Num[][] =>
   ...
   */
  scale3d: (sx: Num, sy: Num, sz: Num): Num[][] =>
   ...
   */
  scale3dh: (sx: Num, sy: Num, sz: Num): Num[][] =>
   ...
   */
  translate3dh: (x: Num, y: Num, z: Num): Num[][] =>
   ...
   */
  lookAt: (eye: VecN, center: VecN, up: VecN): Num[][] =>
  ...
  perspective: (
    ...
    compDict.perspective.body(context, fovy, aspect, zNear, zFar).value
      .contents,
   ...
   */
  project: (p: Vec3, model: Num[][], proj: Num[][], view: Vec4): Vec2 =>
   ...
   */
  projectDepth: (p: Vec3, model: Num[][], proj: Num[][], view: Vec4): Vec3 =>
   ...
   */
  projectList: (p: Vec3[], model: Num[][], proj: Num[][], view: Vec4): Vec2[] =>
   ...
   */
  matrixMultiplyList: (A: Num[][], V: VecN[]): VecN[] =>
   ...
   */
  fromHomogeneousList: (Q: VecN[]): VecN[] =>
   ...
   * @returns Path data
   */
  pathFromPoints: (pathType: string, pts: Vec2[]): PathData =>
   ...
   */
  quadraticCurveFromPoints: (pathType: string, pts: Vec2[]): PathData =>
    compDict.quadraticCurveFromPoints.body(context, pathType, pts).value
      .contents,
   ...
   */
  cubicCurveFromPoints: (pathType: string, pts: Vec2[]): PathData =>
   ...
   */
  connectPaths: (pathType: string, pathDataList: PathData[]): PathData =>
   ...
   */
  concatenatePaths: (pathDataList: PathData[]): PathData =>
   ...
   */
  joinPaths: (pathDataList: PathData[]): PathData =>
   ...
   */
  diffusionProcess: (n: number, X0: Vec2, A: Vec2[], omega: Vec2): Vec2[] =>
   ...
   */
  unitMark: (s1: Line, s2: Line, padding: Num): Vec2[] =>
   ...
   */
  unitMark2: ([start, end]: [Vec2, Vec2], t: string, size: Num): Vec2[] =>
  ...
  circularArc: (
    ...
    compDict.circularArc.body(context, pathType, center, r, theta0, theta1)
      .value.contents,
   ...
   */
  ptOnLine: (p1: VecN, p2: VecN, r: Num): VecN =>
   ...
   */
  arcSweepFlag: ([x1, y1]: Vec2, start: Vec2, end: Vec2): Num =>
   ...
   */
  angleBetween: (u: VecN, v: VecN): Num =>
   ...
   */
  lineLineIntersection: (a0: Vec2, a1: Vec2, b0: Vec2, b1: Vec2): Vec2 =>
   ...
   * @returns Midpoint
   */
  midpoint: (start: VecN, end: VecN): VecN =>
   ...
   */
  midpointOffset: (s1: Line, padding: Num): Vec2 =>
   ...
   */
  chevron: (s1: Line, padding: Num): Vec2[] =>
   ...
   */
  innerPointOffset: (pt1: Vec2, pt2: Vec2, pt3: Vec2, padding: Num): Vec2 =>
   ...
   */
  triangle: (l1: Line, l2: Line, l3: Line): PathData =>
   ...
   */
  average: (xs: VecN): Num => compDict.average.body(context, xs).value.contents,
   ...
   * @returns Normalized vector
   */
  unit: (v: VecN): VecN => compDict.unit.body(context, v).value.contents,
   ...
   */
  random: (minVal: Num, maxVal: Num): Num =>
   ...
   */
  unitRandom: (): Num => compDict.unitRandom.body(context).value.contents,
   ...
   */
  normalRandom: (): Num => compDict.normalRandom.body(context).value.contents,
   ...
   */
  triangleRandom: (a: Vec2, b: Vec2, c: Vec2): Vec2 =>
   ...
   */
  sampleColor: (alpha: Num, colorType: "rgb" | "hsv"): Color =>
    fromPenroseColor(
      compDict.sampleColor.body(context, alpha, colorType).value,
    ),
   ...
   */
  randomIndex: (minIndex: Num, maxIndex: Num): number =>
   ...
   */
  setOpacity: (color: Color, frac: Num): Color =>
    fromPenroseColor(
   ...
   * @returns Barycenter
   */
  barycenter: (a: Vec2, b: Vec2, c: Vec2): Vec2 =>
   ...
   */
  circumcenter: (p: Vec2, q: Vec2, r: Vec2): Vec2 =>
   ...
   */
  circumradius: (p: Vec2, q: Vec2, r: Vec2): Num =>
   ...
   * @returns Incenter
   */
  incenter: (p: Vec2, q: Vec2, r: Vec2): Vec2 =>
   ...
   * @returns Inradius
   */
  inradius: (p: Vec2, q: Vec2, r: Vec2): Num =>
   ...
   * @returns Square of x
   */
  sqr: (x: Num): Num => compDict.sqr.body(context, x).value.contents,
   ...
   */
  sqrt: (x: Num): Num => compDict.sqrt.body(context, x).value.contents,
   ...
   */
  max: (x: Num, y: Num): Num => compDict.max.body(context, x, y).value.contents,
   ...
   */
  min: (x: Num, y: Num): Num => compDict.min.body(context, x, y).value.contents,
   ...
   */
  abs: (x: Num): Num => compDict.abs.body(context, x).value.contents,
