...
const constraints = {
   ...
   */
  equal: (x: Num, y: Num) => constrDict.equal.body(x, y).value,
   ...
   * @param y Second value
   */
  lessThanSq: (x: Num, y: Num) => constrDict.lessThanSq.body(x, y).value,
   ...
   * @param y Second value
   */
  greaterThanSq: (x: Num, y: Num) => constrDict.greaterThanSq.body(x, y).value,
  ...
  overlappingCircleEllipse: (
    ...
    constrDict.overlappingCircleEllipse.body(c1, r1, c2, rx2, ry2, overlap)
      .value,
