...
penrose-synthesizer $EXAMPLE/set-theory-domain/setTheory.dsl --substance=$EXAMPLE/set-theory-domain/threesets.sub --spec=enum-spec.dsl --num-programs=$1 --synth-setting=enum-settings.json
