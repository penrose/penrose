...
penrose-synthesizer ../examples/set-theory-domain/setTheory.dsl --substance=../examples/set-theory-domain/threesets.sub --spec=enum-spec.dsl --num-programs=$1 --max-length=10 --arg-mode=existing
