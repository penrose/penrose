import{a as n}from"./index-3083d8fe.js";const e=`Vector a, b, c
...
Label u $a \\wedge b$
Label v $b \\wedge c$
`,o=n("exterior-algebra"),a=`-- define the size of the drawing
canvas {
   width = 240
   height = 180
}
...
`,l={substance:e,style:[{contents:a,resolver:o}],domain:t,variation:"SnorlaxIbis743",excludeWarnings:["BBoxApproximationWarning"]};export{l as default};
