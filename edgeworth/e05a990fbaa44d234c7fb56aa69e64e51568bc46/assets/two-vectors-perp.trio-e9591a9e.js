import{a as n}from"./index-0dcc9a9a.js";const r=`VectorSpace V
Vector u 
In(u, V)
Vector v 
In(v, V)
...
Orthogonal(v, u)
AutoLabel All
`,e=n("linear-algebra-domain"),t=`canvas {
  width = 800
  height = 700
}
...
`,i={substance:r,style:[{contents:t,resolver:e}],domain:o,variation:""};export{i as default};
