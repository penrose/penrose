import{j as s}from"./jsx-runtime-1438501e.js";import{r as u}from"./index-f46741a2.js";import{S as h,__tla as x}from"./Simple-5dc94811.js";import{v as a}from"./PenrosePrograms-3a44ddda.js";import{__tla as b}from"./svg-2cfb2b44.js";import{__tla as f}from"./vector-wedge.substance-f7ebd76f.js";import{__tla as q}from"./iframe-adee2225.js";import"../sb-preview/runtime.js";let e,c,g,S=Promise.all([(()=>{try{return x}catch{}})(),(()=>{try{return b}catch{}})(),(()=>{try{return f}catch{}})(),(()=>{try{return q}catch{}})()]).then(async()=>{var m,l,p;const i=t=>{const[d,v]=u.useState(0);u.useEffect(()=>{const _=window.setInterval(()=>v(y=>(y+1)%t.examples.length),5e3);return()=>clearInterval(_)},[d]);const r=t.examples[d];return s.jsx(h,{name:"demo",substance:r.sub,style:r.sty,domain:r.dsl,variation:r.variation,interactive:!1,animate:!0,stepSize:r.stepSize,imageResolver:r.imageResolver,excludeWarnings:[]})},n=i;i.__docgenInfo={description:"",methods:[],displayName:"Demo",props:{examples:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  sub: string;
  sty: string;
  dsl: string;
  variation: string;
