...
<svg
 ...
 viewBox='0 0 300 300'  version='1.0'
  ...
  <g
...
</svg>`,Vt=c(async({shape:t,canvasSize:o,pathResolver:r})=>{const e=document.createElementNS("http://www.w3.org/2000/svg","g"),s=[],i=t.properties.href.contents;let n=await r(i);n===void 0&&(console.error(`Could not resolve image path ${i}`),n=Dt),s.push("href"),e.innerHTML=n;const a=e.querySelector("svg"),d=a.getElementsByTagName("defs");return d.length>0&&d[0].querySelectorAll("*").forEach(l=>{l.id!==""&&a.querySelectorAll(`[*|href="#${l.id}"]:not([href])`).forEach(p=>{const u=`${t.properties.name.contents}-ns-${l.id}`;p.setAttributeNS("http://www.w3.org/1999/xlink","href","#"+u),l.setAttribute("id",u)})}),s.push(...j(t,a)),s.push(...I(t,o,e)),s.push(...at(t,o,e)),A(t,e,s),e},"Image"),$=c((t,o,r,e,s,i)=>{const n=document.createElementNS("http://www.w3.org/2000/svg","marker");n.setAttribute("id",t),n.setAttribute("markerUnits","strokeWidth"),n.setAttribute("markerWidth",Y(e.width*s).toString()),n.setAttribute("markerHeight",Y(e.height*s).toString()),n.setAttribute("viewBox",e.viewbox),n.setAttribute("refX",e.refX.toString()),n.setAttribute("refY",e.refY.toString()),i?n.setAttribute("orient","auto"):n.setAttribute("orient","auto-start-reverse");const a=document.createElementNS("http://www.w3.org/2000/svg","path");return a.setAttribute("d",e.path),e.fillKind==="stroke"?(a.setAttribute("fill","none"),n.setAttribute("stroke",o),n.setAttribute("stroke-opacity",r.toString())):(a.setAttribute("fill",o),a.setAttribute("fill-opacity",r.toString())),e.style&&Object.entries(e.style).forEach(([d,l])=>{a.setAttribute(d,l)}),n.appendChild(a),n},"arrowHead"),Wt=c((t,o,r)=>{const e=[],[s,i]=t.properties.start.contents,[n,a]=t.properties.end.contents,d=t.properties.startArrowheadSize.contents,l=t.properties.endArrowheadSize.contents,m=t.properties.strokeWidth.contents;e.push("start","end","startArrowhead","endArrowhead","startArrowheadSize","endArrowheadSize","strokeWidth");const p=Math.sqrt((s-n)**2+(i-a)**2);let u,g;if(o){const f=t.properties.flipStartArrowhead.contents,y=(f?o.refX:o.width-o.refX)*d*m,M=y/p*(s-n);[u,g]=[s-(f?-o.refX:M),i-y/p*(i-a)]}else[u,g]=[s,i];let h,w;if(r){const f=(r.width-r.refX)*l*m;[h,w]=[n-f/p*(n-s),a-f/p*(a-i)]}else[h,w]=[n,a];return[[[u,g],[h,w]],e]},"makeRoomForArrows"),Gt=c(({shape:t,canvasSize:o})=>{const r=T(t.properties.startArrowhead.contents),e=T(t.properties.endArrowhead.contents),[[[s,i],[n,a]],d]=Wt(t,r,e),[l,m]=S([s,i],o),[p,u]=S([n,a],o),g=`M ${l} ${m} L ${p} ${u}`,h=z(t.properties.strokeColor.contents),w=t.properties.strokeWidth.contents,f=N(t.properties.strokeColor.contents),y=document.createElementNS("http://www.w3.org/2000/svg","g"),M=t.properties.name.contents+"-startArrowId",O=t.properties.name.contents+"-endArrowId";if(r){const C=t.properties.startArrowheadSize.contents,E=t.properties.flipStartArrowhead.contents;y.appendChild($(M,h,f,r,C,E))}if(e){const C=t.properties.endArrowheadSize.contents;y.appendChild($(O,h,f,e,C,!1))}d.push("strokeColor","strokeWidth","startArrowhead","flipStartArrowhead","endArrowhead","startArrowheadSize","endArrowheadSize");const k=document.createElementNS("http://www.w3.org/2000/svg","path");return k.setAttribute("d",g),t.properties.strokeColor.contents.tag!=="NONE"&&(k.setAttribute("stroke-opacity",f.toString()),k.setAttribute("stroke-width",w.toString())),k.setAttribute("stroke",h),"strokeDasharray"in t.properties&&t.properties.strokeDasharray.contents!==""?k.setAttribute("stroke-dasharray",t.properties.strokeDasharray.contents):t.properties.strokeStyle.contents==="dashed"&&k.setAttribute("stroke-dasharray",G.toString()),d.push("strokeDasharray","strokeStyle"),"strokeLinecap"in t.properties&&t.properties.strokeLinecap.contents!==""?k.setAttribute("stroke-linecap",t.properties.strokeLinecap.contents):k.setAttribute("stroke-linecap","butt"),d.push("strokeLinecap"),r&&(k.setAttribute("marker-start",`url(#${M})`),d.push("startArrowhead")),e&&(k.setAttribute("marker-end",`url(#${O})`),d.push("endArrowhead")),y.appendChild(k),d.push(...b(t,y)),A(t,y,d),y},"Line"),Xt=c((t,o)=>t.map(r=>{const{cmd:e,contents:s}=r;if(s.length===0&&e!=="Z")return console.error("WARNING: empty path"),"";const i=At.flatten(s.map(n=>{switch(n.tag){case"CoordV":return S(n.contents,o);case"ValueV":return n.contents}})).join(" ");return`${e} ${i}`}).join(" "),"toPathString"),Ft=c(t=>{const o=document.createElementNS("http://www.w3.org/2000/svg","filter");return o.setAttribute("id",t),o.setAttribute("x","0"),o.setAttribute("y","0"),o.setAttribute("width","200%"),o.setAttribute("height","200%"),o.innerHTML=`
    ...
    `,o},"Shadow"),qt=c(({shape:t,canvasSize:o})=>{const r=t.properties.name.contents+"-startArrowId",e=t.properties.name.contents+"-endArrowId",s=t.properties.name.contents+"-shadow",i=document.createElementNS("http://www.w3.org/2000/svg","g"),n=t.properties.strokeWidth.contents,a=z(t.properties.strokeColor.contents),d=N(t.properties.strokeColor.contents),l=z(t.properties.fillColor.contents),m=N(t.properties.fillColor.contents),p=[],u=T(t.properties.startArrowhead.contents),g=T(t.properties.endArrowhead.contents);if(u){const w=t.properties.name.contents+"-startArrowId",f=t.properties.startArrowheadSize.contents,y=t.properties.flipStartArrowhead.contents;i.appendChild($(w,a,d,u,f,y))}if(g){const w=t.properties.name.contents+"-endArrowId",f=t.properties.endArrowheadSize.contents;i.appendChild($(w,a,d,g,f,!1))}p.push("name","strokeColor","startArrowhead","flipStartArrowhead","endArrowhead"),i.appendChild(Ft(s));const h=document.createElementNS("http://www.w3.org/2000/svg","path");return h.setAttribute("stroke",a),h.setAttribute("fill",l),p.push("fillColor","strokeColor"),t.properties.strokeColor.contents.tag!=="NONE"&&(h.setAttribute("stroke-width",n.toString()),h.setAttribute("stroke-opacity",d.toString()),p.push("strokeColor","strokeWidth")),t.properties.fillColor.contents.tag!=="NONE"&&(h.setAttribute("fill-opacity",m.toString()),p.push("fillColor")),"strokeDasharray"in t.properties&&t.properties.strokeDasharray.contents!==""?h.setAttribute("stroke-dasharray",t.properties.strokeDasharray.contents):t.properties.strokeStyle.contents==="dashed"&&h.setAttribute("stroke-dasharray",G.toString()),p.push("strokeDasharray","strokeStyle"),h.setAttribute("d",Xt(t.properties.d.contents,o)),p.push("d"),u&&(h.setAttribute("marker-start",`url(#${r})`),p.push("startArrowhead")),g&&(h.setAttribute("marker-end",`url(#${e})`),p.push("endArrowhead")),i.appendChild(h),p.push(...b(t,i)),A(t,i,p),i},"Path"),Pt=c(({shape:t,canvasSize:o})=>{const r=document.createElementNS("http://www.w3.org/2000/svg","polygon"),e=[];return e.push(...v(t,r)),e.push(...x(t,r)),e.push(...b(t,r)),e.push(...it(t,r)),e.push(...dt(t,o,r)),A(t,r,e),r},"Polygon"),Yt=c(({shape:t,canvasSize:o})=>{const r=document.createElementNS("http://www.w3.org/2000/svg","polyline"),e=[];return e.push(...v(t,r)),e.push(...x(t,r)),e.push(...b(t,r)),e.push(...it(t,r)),e.push(...dt(t,o,r)),A(t,r,e),r},"Polyline"),_t=c(({shape:t,canvasSize:o})=>{const r=document.createElementNS("http://www.w3.org/2000/svg","rect"),e=[];return e.push(...jt(t,o,r)),e.push(...j(t,r)),e.push(...v(t,r)),e.push(...x(t,r)),e.push(...b(t,r)),e.push(...Ot(t,r)),e.push(...I(t,o,r)),A(t,r,e),r},"Rectangle"),Bt=c(({shape:t,canvasSize:o,labels:r})=>{const e=document.createElementNS("http://www.w3.org/2000/svg","text"),s=[];s.push("x","y"),s.push(...v(t,e)),s.push(...x(t,e)),s.push(...b(t,e)),s.push(...Tt(t,e)),s.push(...I(t,o,e)),s.push(...ct(t,e));const i=t.properties.name,n=r.get(i.contents),a=t.properties.center,[d,l]=S(a.contents,o);if(n&&n.tag==="TextData"){const m=n.descent.contents,p=n.height.contents,u=l+(p/2-m);e.setAttribute("x",d.toString()),e.setAttribute("y",u.toString()),s.push(...j(t,e))}else e.setAttribute("x",d.toString()),e.setAttribute("y",l.toString());return A(t,e,s),e},"Text"),Z={Circle:$t,Ellipse:Rt,Rectangle:_t,Polygon:Pt,Polyline:Yt,Equation:It,Path:qt,Line:Gt,Image:Vt,Text:Bt},lt=c(async({shape:t,labels:o,canvasSize:r,pathResolver:e})=>t.shapeType in Z?await Z[t.shapeType]({shape:t,labels:o,canvasSize:r,pathResolver:e}):(console.error(`${t.shapeType} shape doesn't exist in shapeMap`),document.createElementNS("http://www.w3.org/2000/svg","g")),"RenderShape"),J=c(({clientX:t,clientY:o},r)=>{const e=r.getScreenCTM();return e!==null?{x:(t-e.e)/e.a,y:(o-e.f)/e.d}:{x:0,y:0}},"getPosition"),Ut=c(async(t,o,r,e)=>{const s=t.canvasSize,i=await lt(Object.assign(Object.assign({},t),{canvasSize:e||s})),n=document.createElementNS("http://www.w3.org/2000/svg","g"),{shapeType:a}=t.shape;_[a].isLinelike?n.setAttribute("pointer-events","visibleStroke"):_[a].isRectlike?n.setAttribute("pointer-events","bounding-box"):n.setAttribute("pointer-events","auto"),n.appendChild(i);const d=c(l=>{const{clientX:m,clientY:p}=l,{x:u,y:g}=J({clientX:m,clientY:p},r),{width:h,height:w,x:f,y}=l.target.getBBox({stroke:!0}),M=u-f,O=s[0]-h+(u-f),k=g-y,C=s[1]-w+(g-y);n.setAttribute("opacity","0.5");let E=0,D=0;const F=c(ht=>{const{x:ft,y:gt}=J(ht,r),mt=Q(ft,M,O),yt=Q(gt,k,C);E=mt-u,D=g-yt,n.setAttribute("transform",`translate(${E},${-D})`)},"onMouseMove"),q=c(()=>{n.setAttribute("opacity","1"),document.removeEventListener("mouseup",q),document.removeEventListener("mousemove",F),o(t.shape.properties.name.contents,E,D)},"onMouseUp");document.addEventListener("mouseup",q),document.addEventListener("mousemove",F)},"onMouseDown");return n.addEventListener("mousedown",d),n},"DraggableShape"),Ht=c(async(t,o,r)=>{const e=document.createElementNS("http://www.w3.org/2000/svg","svg");e.setAttribute("xmlns","http://www.w3.org/2000/svg"),e.setAttribute("width","100%"),e.setAttribute("height","100%"),e.setAttribute("version","1.2"),e.setAttribute("viewBox",`0 0 ${t.canvas.width} ${t.canvas.height}`);const s=c((i,n,a)=>{o(Nt(t,i,n,a))},"onDrag");for(const i of t.computeShapes(t.varyingValues))e.appendChild(await Ut({shape:i,labels:t.labelCache,canvasSize:t.canvas.size,pathResolver:r},s,e));return e},"RenderInteractive"),Kt=c(async(t,o)=>{const{varyingValues:r,computeShapes:e,labelCache:s,canvas:i}=t,n=document.createElementNS("http://www.w3.org/2000/svg","svg");return n.setAttribute("version","1.2"),n.setAttribute("xmlns","http://www.w3.org/2000/svg"),n.setAttribute("viewBox",`0 0 ${i.width} ${i.height}`),Promise.all(e(r).map(a=>lt({shape:a,labels:s,canvasSize:i.size,pathResolver:o}))).then(a=>{for(const d of a)n.appendChild(d);return n})},"RenderStatic"),Q=c((t,o,r)=>Math.min(Math.max(t,o),r),"clamp"),Zt=c(t=>{const o=St(t.variation),{constraintSets:r,optStages:e}=t,{inputMask:s,objMask:i,constrMask:n}=et(r.get(e[0]),"missing first stage");return rt(Object.assign(Object.assign({},t),{varyingValues:t.inputs.map(a=>a.init.tag==="Sampled"?a.init.sampler(o):a.init.pending),currentStageIndex:0,params:W(s,i,n)}))},"resample"),pt=c((t,o=1e4)=>{const r=Object.assign(Object.assign({},t),t.gradient.step(t,o));return R(r)&&!X(r)?ut(r):r},"stepState"),ut=c(t=>{if(X(t))return t;{const{constraintSets:o,optStages:r,currentStageIndex:e}=t,s=r[e+1],{inputMask:i,objMask:n,constrMask:a}=et(o.get(s),"missing next stage");return Object.assign(Object.assign({},t),{currentStageIndex:e+1,params:W(i,n,a)})}},"nextStage"),Jt=c((t,o=1e4)=>{let r=t;for(;r.params.optStatus!=="Error"&&(!R(r)||!X(r));)R(r)&&(r=ut(r)),r=pt(r,o);return r.params.optStatus==="Error"?ot(Object.assign({errorType:"RuntimeError"},bt("",r))):vt(r)},"stepUntilConvergence"),Qt=c(async t=>{const o=xt(t.domain),r=Mt(s=>Ct(t.substance,s),o);return r.isErr()?ot(r.error):await Et(t.variation,t.style,...r.value)},"compileTrio"),te=c(async t=>{const o=await Lt(t.shapes);if(o.isErr())throw Error(st(o.error));return rt(Object.assign(Object.assign({},t),{labelCache:o.value}))},"prepareState"),R=c(t=>t.params.optStatus==="EPConverged","stateConverged"),X=c(t=>t.currentStageIndex===t.optStages.length-1,"finalStage");async function tt(t){const o=await fetch(t);if(!o.ok){console.error(`could not fetch ${t}`);return}return await o.text()}c(tt,"fetchResolver");class V extends B.Component{canvasRef=B.createRef();penroseState=void 0;timerID=void 0;constructor(o){super(o),this.state={error:void 0}}compile=async()=>{this.penroseState=void 0;const o=await Qt(this.props);o.isOk()?this.penroseState=await te(o.value):this.setState({error:o.error})};converge=async()=>{if(this.penroseState){const o=Jt(this.penroseState);o.isOk()?this.penroseState=o.value:this.setState({error:o.error})}};tick=()=>{this.props.animate&&this.penroseState&&!R(this.penroseState)&&(this.penroseState=pt(this.penroseState,this.props.stepSize??1),this.props.onFrame&&this.props.onFrame(this.penroseState),this.renderCanvas())};componentDidMount=async()=>{await this.compile(),this.props.animate||await this.converge(),this.renderCanvas(),this.timerID=window.setInterval(()=>this.tick(),1e3/60)};componentDidUpdate=async o=>{(this.props.domain!==o.domain||this.props.substance!==o.substance||this.props.style!==o.style)&&(await this.compile(),this.props.animate||await this.converge(),this.renderCanvas()),this.penroseState&&!this.state.error&&(this.props.variation!==o.variation||this.props.animate!==o.animate?(this.penroseState.variation=this.props.variation,this.penroseState=Zt(this.penroseState),this.props.animate||await this.converge(),this.renderCanvas()):this.props.interactive!==o.interactive&&this.renderCanvas())};componentWillUnmount=()=>{clearInterval(this.timerID)};renderCanvas=async()=>{if(this.canvasRef.current===null)return L("div",{children:"rendering..."});{const o=this.canvasRef.current;if(this.penroseState){const r=await(this.props.interactive===!1?Kt(this.penroseState,tt):Ht(this.penroseState,async e=>{this.penroseState=e,this.props.animate||await this.converge(),this.renderCanvas()},tt));o.firstChild!==null?o.replaceChild(r,o.firstChild):o.appendChild(r)}else console.log("state is undefined")}};render=()=>{const{error:o}=this.state;return U("div",{style:{width:"100%",height:"100%"},children:[!o&&L("div",{style:{width:"100%",height:"100%"},ref:this.canvasRef}),o&&U("div",{style:{padding:"1em",height:"100%"},children:[L("div",{style:{fontWeight:700},children:"1 error:"}),L("div",{style:{fontFamily:"monospace"},children:st(o).toString().split(`
...
//# sourceMappingURL=Simple-78654a87.js.map
