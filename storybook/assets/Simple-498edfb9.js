var gt=Object.defineProperty;var c=(t,n)=>gt(t,"name",{value:n,configurable:!0});import{i as it,t as X,a as q,b as v,g as B,d as O,r as P,_ as yt,s as W,e as wt,m as K,f as kt,h as At,j as Z,k as St,n as vt,o as bt,p as xt,q as Mt,u as Ct,v as Et,w as st,x as Rt,y as Nt,c as Lt,A as zt,B as It,C as $t,D as at,E as Tt,F as jt}from"./svg-5e851c3d.js";import{t as Vt,i as ct,m as Gt,c as Ot}from"./CollectLabels-94d70585.js";import{R as J,j as L,a as Q}from"./jsx-runtime-4dee6972.js";const tt={accentHeight:"accent-height",alignmentBaseline:"alignment-baseline",arabicForm:"arabic-form",baselineShift:"baseline-shift",capHeight:"cap-height",clipPath:"clip-path",clipRule:"clip-rule",colorInterpolation:"color-interpolation",colorInterpolationFilters:"color-interpolation-filters",colorProfile:"color-profile",colorRendering:"color-rendering",dominantBaseline:"dominant-baseline",enableBackground:"enable-background",fillOpacity:"fill-opacity",fillRule:"fill-rule",floodColor:"flood-color",floodOpacity:"flood-opacity",fontFamily:"font-family",fontSize:"font-size",fontSizeAdjust:"font-size-adjust",fontStretch:"font-stretch",fontStyle:"font-style",fontVariant:"font-variant",fontWeight:"font-weight",glyphName:"glyph-name",glyphOrientationHorizontal:"glyph-orientation-horizontal",glyphOrientationVertical:"glyph-orientation-vertical",horizAdvX:"horiz-adv-x",horizOriginX:"horiz-origin-x",imageRendering:"image-rendering",letterSpacing:"letter-spacing",lightingColor:"lighting-color",markerEnd:"marker-end",markerMid:"marker-mid",markerStart:"marker-start",overlinePosition:"overline-position",overlineThickness:"overline-thickness",panose1:"panose-1",paintOrder:"paint-order",pointerEvents:"pointer-events",renderingIntent:"rendering-intent",shapeRendering:"shape-rendering",stopColor:"stop-color",stopOpacity:"stop-opacity",strikethroughPosition:"strikethrough-position",strikethroughThickness:"strikethrough-thickness",strokeDasharray:"stroke-dasharray",strokeDashoffset:"stroke-dashoffset",strokeLinecap:"stroke-linecap",strokeLinejoin:"stroke-linejoin",strokeMiterlimit:"stroke-miterlimit",strokeOpacity:"stroke-opacity",strokeWidth:"stroke-width",textAnchor:"text-anchor",textDecoration:"text-decoration",textRendering:"text-rendering",transformOrigin:"transform-origin",underlinePosition:"underline-position",underlineThickness:"underline-thickness",unicodeBidi:"unicode-bidi",unicodeRange:"unicode-range",unitsPerEm:"units-per-em",vAlphabetic:"v-alphabetic",vHanging:"v-hanging",vIdeographic:"v-ideographic",vMathematical:"v-mathematical",vectorEffect:"vector-effect",vertAdvY:"vert-adv-y",vertOriginX:"vert-origin-x",vertOriginY:"vert-origin-y",wordSpacing:"word-spacing",writingMode:"writing-mode"},x=c((t,n,e)=>{const o=["strokeStyle","name","ensureOnCanvas"],r=new Set(e.concat(o));for(const[s,i]of t.passthrough)if(!(i.tag==="StrV"&&i.contents===""||r.has(s)))if(it(s,tt)){const a=tt[s];n.hasAttribute(a)||n.setAttribute(a,i.contents.toString())}else if(s==="style"&&i.contents!==""){const a=n.getAttribute(s);a===null?n.setAttribute(s,i.contents.toString()):n.setAttribute(s,`${a}${i.contents.toString()}`)}else n.hasAttribute(s)||n.setAttribute(s,i.contents.toString())},"attrAutoFillSvg"),C=c((t,n)=>{const e=t.fillColor,o=X(e.contents);return n.setAttribute("fill",q(e.contents)),e.contents.tag!=="NONE"&&n.setAttribute("fill-opacity",o.toString()),["fillColor"]},"attrFill"),dt=c((t,n,e)=>{const o=t.center,[r,s]=v([o.contents[0],o.contents[1]],n);return e.setAttribute("cx",r.toString()),e.setAttribute("cy",s.toString()),["center"]},"attrCenter"),lt=c((t,n)=>{let e=t.scale.contents;e=e||1;let o=n.getAttribute("transform");return o=o===null?`scale(${e})`:o+`scale{${e}}`,n.setAttribute("transform",o),["scale"]},"attrScale"),pt=c((t,n,e)=>{const o=t.center,[r,s]=v([o.contents[0],o.contents[1]],n),i=t.width,a=t.height;let d=e.getAttribute("transform");return d=d===null?`translate(${r-i.contents/2}, ${s-a.contents/2})`:d+`translate(${r-i.contents/2}, ${s-a.contents/2})`,e.setAttribute("transform",d),["center","width","height"]},"attrTransformCoords"),Dt=c((t,n,e)=>{const o=t.center,[r,s]=v([o.contents[0],o.contents[1]],n),i=t.width,a=t.height;return e.setAttribute("x",(r-i.contents/2).toString()),e.setAttribute("y",(s-a.contents/2).toString()),["center","width","height"]},"attrXY"),Y=c((t,n,e)=>{t.width,t.height;const o=t.center,r=t.rotation.contents,[s,i]=v([o.contents[0],o.contents[1]],n);let a=e.getAttribute("transform");return a=a===null?`rotate(${r}, ${s}, ${i})`:a+`rotate(${r}, ${s}, ${i})`,e.setAttribute("transform",a),["rotation","center","width","height"]},"attrRotation"),I=c((t,n)=>{const e=t.width,o=t.height;return n.setAttribute("width",e.contents.toString()),n.setAttribute("height",o.contents.toString()),["width","height"]},"attrWH"),Ft=c((t,n)=>{const e=t.cornerRadius;return n.setAttribute("rx",e.contents.toString()),["cornerRadius"]},"attrCornerRadius"),Xt=c((t,n)=>{const e=t.string,o=document.createTextNode(e.contents.toString());return n.appendChild(o),["string"]},"attrString"),qt="7,5",N=c((t,n)=>{const e=[],o=t.strokeColor,r=X(o.contents),s=t.strokeWidth.contents;return n.setAttribute("stroke",q(o.contents)),e.push("strokeColor","strokeWidth"),o.contents.tag!=="NONE"&&(n.setAttribute("stroke-opacity",r.toString()),n.setAttribute("stroke-width",s.toString()),"strokeDasharray"in t&&t.strokeDasharray.contents!==""?(n.setAttribute("stroke-dasharray",t.strokeDasharray.contents),e.push("strokeDasharray")):"strokeStyle"in t&&t.strokeStyle.contents==="dashed"&&(n.setAttribute("stroke-dasharray",qt.toString()),e.push("strokeDasharray","strokeStyle")),"strokeLinecap"in t&&t.strokeLinecap.contents!==""&&(n.setAttribute("stroke-linecap",t.strokeLinecap.contents),e.push("strokeLinecap"))),e},"attrStroke"),M=c((t,n)=>{const e=t.name,o=document.createElementNS("http://www.w3.org/2000/svg","title");return o.textContent=e.contents,n.appendChild(o),["name"]},"attrTitle"),Yt=c((t,n)=>{const e=Vt(t),o=n.getAttribute("style");return n.setAttribute("style",o?`${o}; font: ${e};`:`font: ${e};`),["fontFamily","fontSize","fontStretch","fontStyle","fontVariant","fontWeight","lineHeigh"]},"attrFont"),ut=c((t,n,e)=>{const r=t.points.contents.map(s=>v([s[0],s[1]],n));return e.setAttribute("points",r.toString()),["points"]},"attrPolyPoints"),Bt=c((t,{canvasSize:n})=>{const e=document.createElementNS("http://www.w3.org/2000/svg","circle"),o=[];return o.push(...C(t,e)),o.push(...dt(t,n,e)),o.push(...N(t,e)),o.push(...M(t,e)),e.setAttribute("r",t.r.contents.toString()),o.push("r"),x(t,e,o),e},"RenderCircle"),_t=c((t,{canvasSize:n})=>{const e=document.createElementNS("http://www.w3.org/2000/svg","ellipse"),o=[];return o.push(...C(t,e)),o.push(...dt(t,n,e)),o.push(...N(t,e)),o.push(...M(t,e)),e.setAttribute("rx",t.rx.contents.toString()),o.push("rx"),e.setAttribute("ry",t.ry.contents.toString()),o.push("ry"),x(t,e,o),e},"RenderEllipse"),et=c((t,[n,e],o)=>{const r=document.createElementNS("http://www.w3.org/2000/svg","text");return r.textContent=t,C(o,r),I(o,r),r.setAttribute("x",`${n}`),r.setAttribute("y",`${e}`),r.setAttribute("alignment-baseline","alphabetic"),r.setAttribute("dominant-baseline","alphabetic"),r.setAttribute("text-anchor","middle"),r},"placeholderString"),Wt=c((t,n)=>{const{canvasSize:e,labels:o,texLabels:r}=n,{center:s}=t,[i,a]=v([s.contents[0],s.contents[1]],e);if(r){const u=a+t.height.contents/2-t.descent.contents;return et(`$${B(t.string)}$`,[i,u],t)}const d=document.createElementNS("http://www.w3.org/2000/svg","g"),p=[];p.push(...Y(t,e,d)),p.push(...pt(t,e,d)),p.push(...M(t,d));const l=o.get(B(t.name));if(l&&l.tag==="EquationData"){const u=l.rendered.cloneNode(!0),h=u.getElementsByTagName("g")[0];p.push(...C(t,h)),p.push(...I(t,u)),h.setAttribute("stroke","none"),h.setAttribute("stroke-width","0");const f=t.fontSize;return u.setAttribute("style",`font-size: ${f.contents}`),d.appendChild(u),x(t,d,p),d}else return et(B(t.string),[i,a],t)},"RenderEquation"),Ut=`<?xml version='1.0' encoding='UTF-8' standalone='no'?>
...
<svg
 ...
 viewBox='0 0 300 300'  version='1.0'
  ...
  <g
...
</svg>`;let Ht=1;const Pt=c((t,n)=>{const e="--inject-",o={clipPath:["clip-path"],"color-profile":null,cursor:null,filter:null,linearGradient:["fill","stroke"],marker:["marker","marker-end","marker-mid","marker-start"],mask:null,pattern:["fill","stroke"],radialGradient:["fill","stroke"]},r=e+Ht++,s=/url\("?#([a-zA-Z][\w:.-]*)"?\)/g,i=t.querySelectorAll("[id]");let a;const d=n?new Set:void 0,p=new Set,l=[];let u=!1,h,f;if(i.length){for(h=0;h<i.length;h++){const y=i[h].localName;it(y,o)&&p.add(y)}p.forEach(y=>{(o[y]||[y]).forEach(function(m){l.indexOf(m)<0&&l.push(m)})}),l.length&&l.push("style");const g=t.getElementsByTagName("*");let w=t,S,k,A;for(h=-1;w!==null;){if(w.localName==="style")k=w.textContent,A=k&&k.replace(s,function(y,m){return d&&d.add(m),"url(#"+m+r+")"}),A!==k&&(w.textContent=A);else if(w.hasAttributes()){for(f=0;f<l.length;f++)S=l[f],k=w.getAttribute(S),A=k&&k.replace(s,function(y,m){return d&&d.add(m),"url(#"+m+r+")"}),A&&A!==k&&w.setAttribute(S,A);for(const y of["xlink:href","href"]){let m=w.getAttribute(y);m&&/^\s*#/.test(m)&&(m=m.trim(),w.setAttribute(y,m+r),d&&d.add(m.substring(1)))}}w=g.item(++h)}for(h=0;h<i.length;h++)a=i[h],(!d||d.has(a.id))&&(a.id+=r,u=!0)}return u},"makeIdsUnique"),Kt=c(async(t,{canvasSize:n,pathResolver:e})=>{const o=document.createElementNS("http://www.w3.org/2000/svg","g"),r=[],s=t.href.contents;let i=await e(s);i===void 0&&(console.error(`Could not resolve image path ${s}`),i=Ut),r.push("href"),o.innerHTML=i;const a=o.querySelector("svg");return Pt(o,!1),r.push(...I(t,a)),r.push(...Y(t,n,o)),r.push(...pt(t,n,o)),r.push(...M(t,o)),x(t,o,r),o},"RenderImage"),D=c((t,n,e,o,r,s)=>{const i=document.createElementNS("http://www.w3.org/2000/svg","marker");i.setAttribute("id",t),i.setAttribute("markerUnits","strokeWidth"),i.setAttribute("markerWidth",P(o.width*r).toString()),i.setAttribute("markerHeight",P(o.height*r).toString()),i.setAttribute("viewBox",o.viewbox),i.setAttribute("refX",o.refX.toString()),i.setAttribute("refY",o.refY.toString()),s?i.setAttribute("orient","auto"):i.setAttribute("orient","auto-start-reverse");const a=document.createElementNS("http://www.w3.org/2000/svg","path");return a.setAttribute("d",o.path),o.fillKind==="stroke"?(a.setAttribute("fill","none"),i.setAttribute("stroke",n),i.setAttribute("stroke-opacity",e.toString())):(a.setAttribute("fill",n),a.setAttribute("fill-opacity",e.toString())),o.style&&Object.entries(o.style).forEach(([d,p])=>{a.setAttribute(d,p)}),i.appendChild(a),i},"arrowHead"),Zt=c((t,n,e)=>{const o=[],[r,s]=[t.start.contents[0],t.start.contents[1]],[i,a]=[t.end.contents[0],t.end.contents[1]],d=t.startArrowheadSize.contents,p=t.endArrowheadSize.contents,l=t.strokeWidth.contents;o.push("start","end","startArrowhead","endArrowhead","startArrowheadSize","endArrowheadSize","strokeWidth");const u=Math.sqrt((r-i)**2+(s-a)**2);if(u===0)return[[[r,s],[i,a]],o];let h,f;if(n){const k=(t.flipStartArrowhead.contents?n.refX:n.width-n.refX)*d*l,A=k/u*(r-i),y=k/u*(s-a);[h,f]=[r-A,s-y]}else[h,f]=[r,s];let g,w;if(e){const S=(e.width-e.refX)*p*l;[g,w]=[i-S/u*(i-r),a-S/u*(a-s)]}else[g,w]=[i,a];return[[[h,f],[g,w]],o]},"makeRoomForArrows"),Jt=c((t,{canvasSize:n,namespace:e,variation:o})=>{const r=O(t.startArrowhead.contents),s=O(t.endArrowhead.contents),[[[i,a],[d,p]],l]=Zt(t,r,s),u=q(t.strokeColor.contents),h=X(t.strokeColor.contents),f=document.createElementNS("http://www.w3.org/2000/svg","g"),g=document.createElementNS("http://www.w3.org/2000/svg","line"),[w,S]=v([i,a],n),[k,A]=v([d,p],n);g.setAttribute("x1",w.toString()),g.setAttribute("y1",S.toString()),g.setAttribute("x2",k.toString()),g.setAttribute("y2",A.toString());const y=`${e}-${o}-${t.name.contents}`,m=y+"-startArrowId",E=y+"-endArrowId";if(r){const R=t.startArrowheadSize.contents,z=t.flipStartArrowhead.contents;f.appendChild(D(m,u,h,r,R,z))}if(s){const R=t.endArrowheadSize.contents;f.appendChild(D(E,u,h,s,R,!1))}return l.push("startArrowhead","flipStartArrowhead","endArrowhead","startArrowheadSize","endArrowheadSize"),l.push(...N(t,g)),r&&(g.setAttribute("marker-start",`url(#${m})`),l.push("startArrowhead")),s&&(g.setAttribute("marker-end",`url(#${E})`),l.push("endArrowhead")),f.appendChild(g),l.push(...M(t,f)),x(t,f,l),f},"RenderLine"),Qt=c((t,n)=>t.map(e=>{const{cmd:o,contents:r}=e;if(r.length===0&&o!=="Z")return console.error("WARNING: empty path"),"";const s=yt.flatten(r.map(i=>{switch(i.tag){case"CoordV":return v([i.contents[0],i.contents[1]],n);case"ValueV":return i.contents}})).join(" ");return`${o} ${s}`}).join(" "),"toPathString"),te=c(t=>{const n=document.createElementNS("http://www.w3.org/2000/svg","filter");return n.setAttribute("id",t),n.setAttribute("x","0"),n.setAttribute("y","0"),n.setAttribute("width","200%"),n.setAttribute("height","200%"),n.innerHTML=`
    ...
    `,n},"Shadow"),ee=c((t,{canvasSize:n})=>{const e=t.name.contents+"-startArrowId",o=t.name.contents+"-endArrowId",r=t.name.contents+"-shadow",s=document.createElementNS("http://www.w3.org/2000/svg","g"),i=q(t.strokeColor.contents),a=X(t.strokeColor.contents),d=[],p=O(t.startArrowhead.contents),l=O(t.endArrowhead.contents);if(p){const h=t.name.contents+"-startArrowId",f=t.startArrowheadSize.contents,g=t.flipStartArrowhead.contents;s.appendChild(D(h,i,a,p,f,g))}if(l){const h=t.name.contents+"-endArrowId",f=t.endArrowheadSize.contents;s.appendChild(D(h,i,a,l,f,!1))}d.push("name","startArrowhead","flipStartArrowhead","endArrowhead"),s.appendChild(te(r));const u=document.createElementNS("http://www.w3.org/2000/svg","path");return d.push(...C(t,u)),d.push(...N(t,u)),u.setAttribute("d",Qt(t.d.contents,n)),d.push("d"),p&&(u.setAttribute("marker-start",`url(#${e})`),d.push("startArrowhead")),l&&(u.setAttribute("marker-end",`url(#${o})`),d.push("endArrowhead")),s.appendChild(u),d.push(...M(t,s)),x(t,s,d),s},"RenderPath"),ne=c((t,{canvasSize:n})=>{const e=document.createElementNS("http://www.w3.org/2000/svg","polygon"),o=[];return o.push(...C(t,e)),o.push(...N(t,e)),o.push(...M(t,e)),o.push(...lt(t,e)),o.push(...ut(t,n,e)),x(t,e,o),e},"RenderPolygon"),oe=c((t,{canvasSize:n})=>{const e=document.createElementNS("http://www.w3.org/2000/svg","polyline"),o=[];return o.push(...C(t,e)),o.push(...N(t,e)),o.push(...M(t,e)),o.push(...lt(t,e)),o.push(...ut(t,n,e)),x(t,e,o),e},"RenderPolyline"),re=c((t,{canvasSize:n})=>{const e=document.createElementNS("http://www.w3.org/2000/svg","rect"),o=[];return o.push(...Dt(t,n,e)),o.push(...I(t,e)),o.push(...C(t,e)),o.push(...N(t,e)),o.push(...M(t,e)),o.push(...Ft(t,e)),o.push(...Y(t,n,e)),x(t,e,o),e},"RenderRectangle"),ie=c((t,{canvasSize:n,labels:e})=>{const o=document.createElementNS("http://www.w3.org/2000/svg","text"),r=[];r.push("x","y"),r.push(...C(t,o)),r.push(...N(t,o)),r.push(...M(t,o)),r.push(...Xt(t,o)),r.push(...Y(t,n,o)),r.push(...Yt(t,o));const s=t.name,i=e.get(s.contents),a=t.center,[d,p]=v([a.contents[0],a.contents[1]],n);if(i&&i.tag==="TextData"){const l=i.descent.contents,u=i.height.contents,h=p+(u/2-l);o.setAttribute("x",d.toString()),o.setAttribute("y",h.toString()),r.push(...I(t,o))}else o.setAttribute("x",d.toString()),o.setAttribute("y",p.toString());return o.setAttribute("font-size-adjust",t.fontSizeAdjust.contents),o.setAttribute("alignment-baseline",t.alignmentBaseline.contents),o.setAttribute("dominant-baseline",t.dominantBaseline.contents),o.setAttribute("ascent",t.ascent.contents.toString()),o.setAttribute("descent",t.descent.contents.toString()),o.setAttribute("text-anchor",t.textAnchor.contents.toString()),o.setAttribute("visibility",t.visibility.contents),r.push("fontSizeAdjust","alignmentBaseline","dominantBaseline","ascent","descent","textAnchor","visibility"),x(t,o,r),o},"RenderText"),se=c((t,n,e,o)=>{const r=[...t.varyingValues];return{...t,params:W(r.length),varyingValues:r}},"dragUpdate"),nt=c(({clientX:t,clientY:n},e)=>{const o=e.getScreenCTM();return o!==null?{x:(t-o.e)/o.a,y:(n-o.f)/o.d}:{x:0,y:0}},"getPosition"),ae=c(async(t,n,e,o)=>{const r=document.createElementNS("http://www.w3.org/2000/svg","svg");r.setAttribute("xmlns","http://www.w3.org/2000/svg"),r.setAttribute("version","1.2"),r.setAttribute("viewBox",`0 0 ${t.canvas.width} ${t.canvas.height}`);const s=c((a,d,p)=>{n(se(t))},"onDrag"),i=t.computeShapes(t.varyingValues);return await ht(i,r,{labels:t.labelCache,canvasSize:t.canvas.size,variation:t.variation,namespace:o,texLabels:!1,pathResolver:e},{updateState:n,onDrag:s,parentSVG:r}),r},"RenderInteractive"),ce=c(async(t,n,e,o=!1)=>{const{varyingValues:r,computeShapes:s,labelCache:i,canvas:a,variation:d}=t,p=document.createElementNS("http://www.w3.org/2000/svg","svg");p.setAttribute("version","1.2"),p.setAttribute("xmlns","http://www.w3.org/2000/svg"),p.setAttribute("viewBox",`0 0 ${a.width} ${a.height}`);const l=s(r),u=l.map(b=>wt(b)),h=K(u.map(b=>kt(b))),f=K(u.map(b=>At(b))),g=Z(u.map(b=>St(b))),w=Z(u.map(b=>vt(b))),S=[h,f,g,w],[k,A,y,m]=(await bt(xt(S)))(b=>b.val).secondary,[E,R]=v([k,A],[a.width,a.height]),[z,$]=v([y,m],[a.width,a.height]),T=[E,$],j=[z-E,R-$];p.setAttribute("penrose","0");const V=document.createElementNS("https://penrose.cs.cmu.edu/metadata","penrose"),H=document.createElementNS("https://penrose.cs.cmu.edu/croppedViewBox","croppedViewBox");return H.insertAdjacentText("afterbegin",`${T[0]} ${T[1]} ${j[0]} ${j[1]}`),V.appendChild(H),p.appendChild(V),await ht(l,p,{labels:i,canvasSize:a.size,variation:d,namespace:e,texLabels:o,pathResolver:n},void 0),p},"RenderStatic"),de=c(async(t,n,e)=>{const o=document.createElementNS("http://www.w3.org/2000/svg","g"),r=t.clipPath.contents;let s,i;if(r.tag==="Clip"){const d=r.contents;s=d.name.contents;const p=await G(d,n,e),l=document.createElementNS("http://www.w3.org/2000/svg","clipPath");i=n.namespace+s+"-clip",l.setAttribute("id",i),l.appendChild(p),o.appendChild(l)}const a=t.shapes.contents;for(const d of a){const p=d.name.contents;if(r.tag==="Clip"){if(p!==s){const l=await G(d,n,e);l.setAttribute("clip-path",`url(#${i})`),o.appendChild(l)}}else{const l=await G(d,n,e);o.appendChild(l)}}return x(t,o,[...M(t,o),"shapes","clipPath"]),o},"RenderGroup"),le=c(async(t,n)=>{switch(t.shapeType){case"Circle":return Bt(t,n);case"Ellipse":return _t(t,n);case"Equation":return Wt(t,n);case"Image":return Kt(t,n);case"Line":return Jt(t,n);case"Path":return ee(t,n);case"Polygon":return ne(t,n);case"Polyline":return oe(t,n);case"Rectangle":return re(t,n);case"Text":return ie(t,n)}},"RenderShapeSvg"),G=c(async(t,n,e)=>{if(t.shapeType==="Group")return await de(t,n,e);{const o=await le(t,n);if(e){const r=document.createElementNS("http://www.w3.org/2000/svg","g");Mt(t)?r.setAttribute("pointer-events","visibleStroke"):Ct(t)?r.setAttribute("pointer-events","bounding-box"):r.setAttribute("pointer-events","auto"),r.appendChild(o);const s=c(i=>{const{clientX:a,clientY:d}=i,{x:p,y:l}=nt({clientX:a,clientY:d},e.parentSVG),{width:u,height:h,x:f,y:g}=i.target.getBBox({stroke:!0}),w=p-f,S=n.canvasSize[0]-u+(p-f),k=l-g,A=n.canvasSize[1]-h+(l-g);r.setAttribute("opacity","0.5");let y=0,m=0;const E=c(z=>{const{x:$,y:T}=nt(z,e.parentSVG),j=ot($,w,S),V=ot(T,k,A);y=j-p,m=l-V,r.setAttribute("transform",`translate(${y},${-m})`)},"onMouseMove"),R=c(()=>{r.setAttribute("opacity","1"),document.removeEventListener("mouseup",R),document.removeEventListener("mousemove",E),e.onDrag(t.name.contents,y,m)},"onMouseUp");document.addEventListener("mouseup",R),document.addEventListener("mousemove",E)},"onMouseDown");return r.addEventListener("mousedown",s),r}else return o}},"RenderShape"),ht=c(async(t,n,e,o)=>{for(const r of t){const s=await G(r,e,o);n.appendChild(s)}},"RenderShapes"),ot=c((t,n,e)=>Math.min(Math.max(t,n),e),"clamp"),pe=c(t=>{const n=Et(t.variation);return ct({...t,varyingValues:t.inputs.map(({meta:e})=>e.init.tag==="Sampled"?e.init.sampler(n):e.init.pending),currentStageIndex:0,params:W(t.varyingValues.length)})},"resample"),ue=c((t,n)=>{const{constraintSets:e,optStages:o,currentStageIndex:r}=t,s=o[r],i=Tt(e.get(s),"missing stage"),a=new Float64Array(t.varyingValues);let d=0;const p=jt((l,u,h)=>t.gradient(i,l,u,h).phi,a,t.params,()=>d++>=n);return{...t,varyingValues:Array.from(a),params:p}},"step"),ft=c((t,n=1e4)=>{const e=ue(t,n);return F(e)&&!U(e)?mt(e):e},"stepState"),mt=c(t=>U(t)?t:{...t,currentStageIndex:t.currentStageIndex+1,params:W(t.varyingValues.length)},"nextStage"),he=c((t,n=1e4)=>{let e=t;for(;e.params.optStatus!=="Error"&&(!F(e)||!U(e));)F(e)&&(e=mt(e)),e=ft(e,n);return e.params.optStatus==="Error"?st({errorType:"RuntimeError",...Rt("",e)}):Nt(e)},"stepUntilConvergence"),fe=c(async t=>{const n=Lt(t.domain),e=zt(r=>It(t.substance,r),n);return e.isErr()?st(e.error):await $t(t.variation,t.style,...e.value)},"compileTrio"),me=c(async t=>{const n=Gt(),e=await Ot(t.shapes,n);if(e.isErr())throw Error(at(e.error));return ct({...t,labelCache:e.value})},"prepareState"),F=c(t=>t.params.optStatus==="EPConverged","stateConverged"),U=c(t=>t.currentStageIndex===t.optStages.length-1,"finalStage");async function rt(t){const n=await fetch(t);if(!n.ok){console.error(`could not fetch ${t}`);return}return await n.text()}c(rt,"fetchResolver");class _ extends J.Component{canvasRef=J.createRef();penroseState=void 0;timerID=void 0;constructor(n){super(n),this.state={error:void 0}}compile=async()=>{this.penroseState=void 0,this.setState({error:void 0});const n=await fe(this.props);n.isOk()?(this.penroseState=await me(n.value),this.setState({error:void 0})):this.setState({error:n.error})};converge=async()=>{if(this.penroseState){const n=he(this.penroseState);n.isOk()?this.penroseState=n.value:this.setState({error:n.error})}};tick=()=>{this.props.animate&&this.penroseState&&!F(this.penroseState)&&(this.penroseState=ft(this.penroseState,this.props.stepSize??1),this.renderCanvas())};componentDidMount=async()=>{await this.compile(),this.props.animate||await this.converge(),this.renderCanvas(),this.timerID=window.setInterval(()=>this.tick(),1e3/60)};componentDidUpdate=async n=>{if(this.props.domain!==n.domain||this.props.substance!==n.substance||this.props.style!==n.style){await this.compile(),this.props.animate||await this.converge(),this.renderCanvas();return}if(this.penroseState&&!this.state.error){if(this.props.variation!==n.variation||this.props.animate!==n.animate){this.penroseState.variation=this.props.variation,this.penroseState=pe(this.penroseState),this.props.animate||await this.converge(),this.renderCanvas();return}else if(this.props.interactive!==n.interactive){this.renderCanvas();return}}};componentWillUnmount=()=>{clearInterval(this.timerID)};renderCanvas=async()=>{if(this.canvasRef.current===null)return L("div",{children:"rendering..."});{const n=this.canvasRef.current;if(this.penroseState){const e=await(this.props.interactive===!1?ce(this.penroseState,this.props.imageResolver??rt,this.props.name??""):ae(this.penroseState,async o=>{this.penroseState=o,this.props.animate||await this.converge(),this.renderCanvas()},this.props.imageResolver??rt,this.props.name??""));n.firstChild!==null?n.replaceChild(e,n.firstChild):n.appendChild(e),this.props.onFrame&&this.props.onFrame(this.penroseState)}else return L("div",{children:"rendering..."})}};render=()=>{const{error:n}=this.state;return Q("div",{style:{width:"100%",height:"100%"},children:[!n&&L("div",{style:{width:"100%",height:"100%"},ref:this.canvasRef}),n&&Q("div",{style:{padding:"1em",height:"100%"},children:[L("div",{style:{fontWeight:700},children:"1 error:"}),L("div",{style:{fontFamily:"monospace"},children:at(n).toString().split(`
`).map((e,o)=>L("p",{style:{margin:0},children:e},`err-ln-${o}`))})]})]})}}c(_,"Simple");try{_.displayName="Simple",_.__docgenInfo={description:"",displayName:"Simple",props:{domain:{defaultValue:null,description:"",name:"domain",required:!0,type:{name:"string"}},substance:{defaultValue:null,description:"",name:"substance",required:!0,type:{name:"string"}},style:{defaultValue:null,description:"",name:"style",required:!0,type:{name:"string"}},variation:{defaultValue:null,description:"",name:"variation",required:!0,type:{name:"string"}},stepSize:{defaultValue:null,description:"",name:"stepSize",required:!1,type:{name:"number"}},interactive:{defaultValue:null,description:"",name:"interactive",required:!1,type:{name:"boolean"}},animate:{defaultValue:null,description:"",name:"animate",required:!1,type:{name:"boolean"}},onFrame:{defaultValue:null,description:"",name:"onFrame",required:!1,type:{name:"((frame: State) => void)"}},imageResolver:{defaultValue:null,description:"",name:"imageResolver",required:!1,type:{name:"PathResolver"}},name:{defaultValue:null,description:"",name:"name",required:!1,type:{name:"string"}}}}}catch{}export{_ as S};
//# sourceMappingURL=Simple-498edfb9.js.map
