...
AutoLabel All
`,j={"fake3d.domain":q,"fake3d.style":D,"projection.substance":R},W=`type Text
type Point
`,$=`canvas {
   scalar width  = 533.
   scalar height = 300.
...
Edge(d, f)
Edge(e, f)
`,Zt={"ex18.substance":Qt,"ex21.substance":qt,"ex30.substance":Dt,"ex31.substance":Rt,"ex32.substance":jt,"ex33.substance":Wt,"ex34.substance":$t,"ex35.substance":Ft,"ex36.substance":Ht,"ex46.substance":zt,"ex47a.substance":Ut,"ex47b.substance":Kt,"ex47c.substance":Xt,"ex47d.substance":Yt},Jt=`Vertex a, b, c, d, e, f
...
Orthogonal(x1, x2)
AutoLabel All
`,qo={"dependent.substance":Oo,"error-test.style":Bo,"independent.substance":Mo,"linear-algebra-paper-simple.style":Go,"linear-algebra-test.domain":Vo,"linear-algebra.domain":Io,"linearalgebra-paper-dashes.style":No,"twoVectorsPerp-unsugared.substance":_o,"twoVectorsPerp.substance":Qo},Do=`canvas {
    width = 800
    height = 700
}
...
constructor MakeConnection(Node A, Node B) -> Connection`,$o={"distinctive-shape.style":Do,"full-adder.substance":Ro,"half-adder.substance":jo,"logic-gates.domain":Wo},Fo=`type Scalar
type Vector
type Matrix
...
`,qr={"penrose-sound-example.svg":Ir,"sound-test.substance":Nr,"sound.domain":_r,"sound.style":Qr},Dr=`<svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 700">
  <circle
    fill="#339933"
    fill-opacity="0.3"
...
`,Hr={"example.svg":Dr,"persistent-homology-basic.style":Rr,"persistent-homology-shading.svg":jr,"persistent-homology.domain":Wr,"persistent-homology.style":$r,"persistent-homology.substance":Fr},zr=`canvas {
  width = 800
  height = 700
}
...
AutoLabel All
`,D0=`-- ethanol molecule, expressed via structural-formula DSL
Carbon C1, C2
...
AutoLabel All
`,R0=`-- glucose molecule, expressed via structural-formula DSL
Oxygen O1
Hydrogen H1, H2, H3, H4
...
`,j0=`-- methane molecule, expressed via structural-formula DSL
Carbon C1
Hydrogen H1, H2, H3, H4
...
AutoLabel All
`,H0={"acetic-acid.substance":_0,"caffeine-reduced.substance":Q0,"caffeine.substance":q0,"ethanol.substance":D0,"glucose.substance":R0,"methane.substance":j0,"photosynthesis-half.substance":W0,"photosynthesis.substance":$0,"water.substance":F0},z0=`-- TODO would be really helpful to be able to join multiple
...
`,ta={images:N0,molecules:H0,"pseudo-3d-reaction.style":z0,"pseudo-3d.style":U0,reactions:Z0,"structural-formula-atom.svg":J0,"structural-formula.domain":na,"structural-formula.style":ea},oa=`-- angle-equivalence.substance
-- 
...
`,ca=`-- length-cross-ratio.substance
-- 
...
HasLabel( k )
HasLabel( l )
`,da=`-- relative-orientation.substance
-- 
...
AutoLabel All
`,fa=`-- create a triangle with vertices i, j, k
Vertex i, j, k
Edge ij := MakeEdge(i,j)
Edge jk := MakeEdge(j,k)
Edge ki := MakeEdge(k,i)
...
Label j "j"
Label k "k"
`,ua={"angle-equivalence.substance":oa,"concyclic-pair.substance":ra,"cotan-formula.substance":aa,"edge-label-test.substance":ia,"example.substance":la,"halfedge-mesh.substance":sa,"length-cross-ratio.substance":ca,"relative-orientation.substance":da,"segment-intersection-test.substance":pa,"triangle-label-test.substance":ga,"triangleCenters.substance":fa},ha=`type Point
type Vertex
type Triangle
...
--- concyclic-pair ---    ensure disjoint( c.textBounds, e.segment )
--- concyclic-pair --- }`,ma={diagrams:ua,"triangle-mesh-2d-minimal.domain":ha,"triangle-mesh-2d-minimal.style":ba,"triangle-mesh-2d.domain":va,"triangle-mesh-2d.style":ka},xa=`type Triangle
`,ya=`canvas {
   width = 200
   height = 200
}
...
`,Ca={"triangle-mesh-3d.domain":xa,"triangle-mesh-3d.style":ya,"two-triangles.substance":wa},La=`/* This is the starter code for the domain file of tutorial 1,
...
-- End your code above
`,Aa=`/* This is the starter code for the style file of tutorial 1,
 * which teaches the basics of Penrose. Follow along with the write-up. 
 * Good luck! :)
 */
...
-- End your code above
`,Sa={"setTheory.domain":La,"twoSets.style":Aa,"twoSets.substance":Pa},Ea=`/* This is the starter code for the domain program for tutorial 2,
...
-- End your code above
`,Ta=`/* This is the starter code for the style program for tutorial 2,
 * which covers constraints in Penrose. Follow along with the write-up.
 * Good luck! :)
 */
...
`,Oa=`/* This is the starter code for the substance program for tutorial 2,
 * which covers constraints in Penrose. Follow along with the write-up.
 * Good luck! :)
 */
...
-- End your code above
`,Ba={"setTheory.domain":Ea,"subset.style":Ta,"subset.substance":Oa},Ma=`/* This is the starter code for the domain program for tutorial 3,
...
-- End your code above
`,Ga=`/* This is the starter code for the style program for tutorial 3,
...
-- End your code above
AutoLabel All /* leave this as the last line */`,Ia={"linearAlgebra.domain":Ma,"vector.style":Ga,"vector.substance":Va},Na={tutorial1:Sa,tutorial2:Ba,tutorial3:Ia},_a={},Qa={},qa={tutorial3:Qa},Da={code:Na,solutions:_a,supplementary:qa},Ra=`-- Describe a short walk used to estimate the solution to
...
`,ja=`-- Describe a nested walk used to estimate the solution to,
...
`,Wa=`-- Describe a short walk used to estimate the solution to
...
`,Fa=`<svg version="1.2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 240">
...
`,Ka={"wos-laplace-estimator-walk-on-spheres.svg":Fa,"wos-nested-estimator-walk-on-spheres.svg":Ha,"wos-offcenter-estimator-walk-on-spheres.svg":za,"wos-poisson-estimator-walk-on-spheres.svg":Ua},Xa=`<?xml version="1.0" encoding="utf-8"?>
<!-- Generator: Adobe Illustrator 26.3.1, SVG Export Plug-In . SVG Version: 6.00 Build 0) -->
...
`,Ja={"Laplace.substance":Ra,"Nested.substance":ja,"OffCenter.substance":Wa,"Poisson.substance":$a,images:Ka,"walk-on-spheres-ball.svg":Xa,"walk-on-spheres.domain":Ya,"walk-on-spheres.style":Za},ni=`AWord Shells
AWord Minkowski
AWord Exact
AWord Riemannian
AWord BCs
...
`,ti=`-- Set the target diagram size
canvas {
   width = 240
   height = 180
}
...
`,oi={"example.substance":ni,"word-cloud.domain":ei,"word-cloud.style":ti},n={animation:a,"atoms-and-bonds":d,"closest-point":u,"closest-point-ellipse":k,"curve-examples":O,"existential-graph-domain":V,"exterior-algebra":Q,"fake-3d-linear-algebra":j,"fancy-text":H,"full-moon":X,"geometry-domain":On,"graph-domain":oo,"group-theory":go,"hyperbolic-domain":ko,hypergraph:Lo,"lagrange-bases":To,"linear-algebra-domain":qo,"logic-circuit-domain":$o,"matrix-ops":dr,"mesh-set-domain":hr,"minkowski-tests":Pr,mobius:Or,molecules:e,"monoidal-category-domain":Vr,"penrose-sound":qr,"persistent-homology":Hr,"set-theory-domain":d0,"shape-distance":L0,"shape-spec":O0,"spec-shape-callout":I0,"structural-formula":ta,"triangle-mesh-2d":ma,"triangle-mesh-3d":Ca,tutorials:Da,"walk-on-spheres":Ja,"word-cloud":oi},ai={domain:"typeppp Set",substancce:"Set A + B",style:`
  Set a {
...
`,variation:""},li={substance:n["set-theory-domain"]["continuousmap.substance"],style:n["set-theory-domain"]["continuousmap.style"],domain:n["set-theory-domain"]["functions.domain"],variation:""},si={variation:"ArtemisCrane740",domain:n["exterior-algebra"]["exterior-algebra.domain"],substance:n["exterior-algebra"]["vector-wedge.substance"],style:n["exterior-algebra"]["exterior-algebra.style"]},ci={variation:"MyrtleApe55311",domain:n["linear-algebra-domain"]["linear-algebra.domain"],substance:n["linear-algebra-domain"]["twoVectorsPerp-unsugared.substance"],style:n["linear-algebra-domain"]["linear-algebra-paper-simple.style"]};export{si as a,li as c,ai as e,ii as o,ci as v};
//# sourceMappingURL=PenrosePrograms-ab6d2732.js.map
