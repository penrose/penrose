import{s as T,a as W,r as R,d as O,m as p,__tla as __tla_0}from"./vector-wedge.substance-ff4a0917.js";import{r as a,j as n,a as d,F as G}from"./jsx-runtime-f52d669f.js";import{s as i}from"./styled-components.browser.esm-319ab923.js";import{S as E,__tla as __tla_1}from"./Simple-fdacff97.js";import{R as Q,L as z}from"./Resample-caa82516.js";import{__tla as __tla_2}from"./iframe-41922123.js";import"./index-5b359ca1.js";import"./hoist-non-react-statics.cjs-852a5bb6.js";import{__tla as __tla_3}from"./svg-55f5b29b.js";let X,nn,Z,un,hn;let __tla=Promise.all([(()=>{try{return __tla_0}catch{}})(),(()=>{try{return __tla_1}catch{}})(),(()=>{try{return __tla_2}catch{}})(),(()=>{try{return __tla_3}catch{}})()]).then(async()=>{var L=Object.defineProperty;var c=(e,s)=>L(e,"name",{value:s,configurable:!0});const o={substance:T,style:[{contents:W,resolver:R}],domain:O,variation:"SnorlaxIbis743",excludeWarnings:["BBoxApproximationWarning"]},I=`-- name in registry: incenter-triangle
Point J, K, L, P, m
...
}`,F=p("geometry-domain/textbook_problems"),j=`global {
...
-- AutoLabel A, B, C, D`,r={substance:I,style:[{contents:M,resolver:N},{contents:j,resolver:F}],domain:_,variation:"RationalityZebra567",excludeWarnings:["BBoxApproximationWarning"]},$=`-- A short walk used to estimate the solution to
...
forall Domain D {
   ...
   -- be supported for all shapes (like arbitrary B\xe9zier curves).
...
`,Y=i.div`
  ...
  justify-content: center;
  margin: 10px 0px;
`,b=c(e=>{const{trio:s,imageResolver:m}=e,{variation:v,substance:f,style:C,domain:k}=s,[B,y]=a.useState(v),[S,D]=a.useState(0),[P,w]=a.useState(!1),[A,x]=a.useState([""]);return n(J,{children:P?d(G,{children:[n(E,{name:"embed",domain:k,substance:f,style:C,variation:B,interactive:!1,animate:!0,stepSize:5,imageResolver:m,onFrame:t=>{x(t.optStages),D(t.currentStageIndex)}}),d(Y,{children:[A.map((t,q)=>{const u=t===""?"default":t;return q===S?n(g,{$active:!0,children:u}):n(g,{children:u})}),n("div",{onClick:()=>y(Math.random().toString()),style:{cursor:"pointer"},children:n(Q,{size:28,color:"black"})})]})]}):d("div",{style:{display:"flex",alignItems:"center",justifyContent:"center"},children:[n(V,{onClick:()=>w(!0),children:"Click to lay out the diagram"}),n(z,{width:350,color:"#0001"})]})})},"StagedDiagram$1");try{StagedDiagram.displayName="StagedDiagram",StagedDiagram.__docgenInfo={description:"",displayName:"StagedDiagram",props:{trio:{defaultValue:null,description:"",name:"trio",required:!0,type:{name:"{ substance: string; domain: string; style: string; variation: string; }"}},imageResolver:{defaultValue:null,description:"",name:"imageResolver",required:!0,type:{name:"PathResolver"}}}}}catch{}let h;hn={parameters:{storySource:{source:`import vector from "@penrose/examples/dist/exterior-algebra/vector-wedge.trio";
...
`,locationsMap:{"walk-on-sphere":{startLoc:{col:55,line:13},endLoc:{col:1,line:17},startBody:{col:55,line:13},endBody:{col:1,line:17}},geometry:{startLoc:{col:55,line:13},endLoc:{col:1,line:17},startBody:{col:55,line:13},endBody:{col:1,line:17}},vector:{startLoc:{col:55,line:13},endLoc:{col:1,line:17},startBody:{col:55,line:13},endBody:{col:1,line:17}}}}},title:"Example/StagedDiagram Component",component:b};h=c(e=>n("div",{style:{width:"50%"},children:n(b,{...e})}),"Template");Z=h.bind({});Z.args={trio:{substance:l.substance,style:l.style[0].contents,domain:l.domain,variation:"test3"},imageResolver:l.style[0].resolver};X=h.bind({});X.args={trio:{substance:r.substance,style:r.style[0].contents,domain:r.domain,variation:"test"},imageResolver:r.style[0].resolver};nn=h.bind({});nn.args={trio:{substance:o.substance,style:o.style[0].contents,domain:o.domain,variation:"test"},imageResolver:o.style[0].resolver};un=["WalkOnSphere","Geometry","Vector"]});export{X as Geometry,nn as Vector,Z as WalkOnSphere,un as __namedExportsOrder,hn as default,__tla};