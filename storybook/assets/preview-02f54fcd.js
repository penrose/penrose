import{d as E}from"./index-356e4a49.js";const{useMemo:b,useEffect:_}=__STORYBOOK_MODULE_PREVIEW_API__,{global:M}=__STORYBOOK_MODULE_GLOBAL__,{logger:h}=__STORYBOOK_MODULE_CLIENT_LOGGER__;var c="backgrounds",{document:l,window:k}=M,O=()=>k.matchMedia("(prefers-reduced-motion: reduce)").matches,L=(a,e=[],r)=>{if(a==="transparent")return"transparent";if(e.find(n=>n.value===a))return a;let t=e.find(n=>n.name===r);if(t)return t.value;if(r){let n=e.map(o=>o.name).join(", ");h.warn(E`
