import{m as n}from"./resolver-66ef16e8.js";const a=n("walk-on-spheres"),l=`layout = [ walkStage, nestStage, labelStage, legendStage ]
...
where St := starAround(p) {
   ...
   -- this group should ideally also include St.shading, but
   -- there appears to be a bug with clipping imported images
   -- (or perhaps gradients)
   shape St.G = Group {
      shapes: [St.ball] -- [St.ball,St.shading]
...
`;export{t as d,a as r,l as s};
//# sourceMappingURL=walk-on-spheres.domain-fbc1bc3b.js.map
