import{j as s}from"./jsx-runtime-1438501e.js";import{r as u}from"./index-f46741a2.js";import{S as h,__tla as x}from"./Simple-add1c8a1.js";import{v as a}from"./PenrosePrograms-78669588.js";import{__tla as b}from"./svg-c8f61f75.js";import{__tla as f}from"./vector-wedge.substance-92d42973.js";import{__tla as q}from"./iframe-9bbcd2e4.js";import"../sb-preview/runtime.js";let e,c,g,S=Promise.all([(()=>{try{return x}catch{}})(),(()=>{try{return b}catch{}})(),(()=>{try{return f}catch{}})(),(()=>{try{return q}catch{}})()]).then(async()=>{var m,l,p;const i=t=>{const[d,v]=u.useState(0);u.useEffect(()=>{const _=window.setInterval(()=>v(y=>(y+1)%t.examples.length),5e3);return()=>clearInterval(_)},[d]);const r=t.examples[d];return s.jsx(h,{name:"demo",substance:r.sub,style:r.sty,domain:r.dsl,variation:r.variation,interactive:!1,animate:!0,stepSize:r.stepSize,imageResolver:r.imageResolver,excludeWarnings:[]})},n=i;i.__docgenInfo={description:"",methods:[],displayName:"Demo",props:{examples:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  sub: string;
  sty: string;
  dsl: string;
  variation: string;
