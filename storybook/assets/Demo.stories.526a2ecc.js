import{r as a}from"./index.5c77362b.js";import{S as l}from"./Simple.763b709c.js";import{j as o}from"./jsx-runtime.1c361ae2.js";import{v as n,a as r}from"./PenrosePrograms.c74bd284.js";import"./vendor.e66cac25.js";const i=e=>{const[s,d]=a.exports.useState(0);a.exports.useEffect(()=>{const p=window.setInterval(()=>d(c=>(c+1)%e.examples.length),5e3);return()=>clearInterval(p)},[s]);const t=e.examples[s];return o("div",{style:{width:e.width,height:e.width},children:o(l,{substance:t.sub,style:t.sty,domain:t.dsl,variation:t.variation,interactive:!1,animate:!0})})};var m=i;i.__docgenInfo={description:"",methods:[],displayName:"Demo",props:{examples:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  sub: string;
  sty: string;
  dsl: string;
  variation: string;
  ...
  dsl: string;
  variation: string;
}[]`},description:""},width:{required:!0,tsType:{name:"string"},description:""},darkMode:{required:!0,tsType:{name:"boolean"},description:""}}};var f={parameters:{storySource:{source:`import { ComponentMeta, ComponentStory } from "@storybook/react";
