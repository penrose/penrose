...
</svg>`;let Vt=1;const Gt=c((t,o)=>{const r="--inject-",e={clipPath:["clip-path"],"color-profile":null,cursor:null,filter:null,linearGradient:["fill","stroke"],marker:["marker","marker-end","marker-mid","marker-start"],mask:null,pattern:["fill","stroke"],radialGradient:["fill","stroke"]},s=r+Vt++,i=/url\("?#([a-zA-Z][\w:.-]*)"?\)/g,n=t.querySelectorAll("[id]");let a;const l=o?[]:null;let d;const f={},p=[];let g=!1,u,m;if(n.length){for(u=0;u<n.length;u++)d=n[u].localName,d in e&&(f[d]=1);for(d in f)(e[d]||[d]).forEach(function(S){p.indexOf(S)<0&&p.push(S)});p.length&&p.push("style");const v=t.getElementsByTagName("*");let h=t,b,w,k;for(u=-1;h!==null;){if(h.localName==="style")w=h.textContent,k=w&&w.replace(i,function(S,y){return l&&(l[y]=1),"url(#"+y+s+")"}),k!==w&&(h.textContent=k);else if(h.hasAttributes()){for(m=0;m<p.length;m++)b=p[m],w=h.getAttribute(b),k=w&&w.replace(i,function(S,y){return l&&(l[y]=1),"url(#"+y+s+")"}),k&&k!==w&&h.setAttribute(b,k);for(const S of["xlink:href","href"]){let y=h.getAttribute(S);y&&/^\s*#/.test(y)&&(y=y.trim(),h.setAttribute(S,y+s),l&&(l[y.substring(1)]=1))}}h=v.item(++u)}for(u=0;u<n.length;u++)a=n[u],(!l||l[a.id])&&(a.id+=s,g=!0)}return g},"makeIdsUnique"),Ft=c(async({shape:t,canvasSize:o,pathResolver:r})=>{const e=document.createElementNS("http://www.w3.org/2000/svg","g"),s=[],i=t.properties.href.contents;let n=await r(i);n===void 0&&(console.error(`Could not resolve image path ${i}`),n=Dt),s.push("href"),e.innerHTML=n;const a=e.querySelector("svg");return Gt(e,!1),s.push(...I(t,a)),s.push(...G(t,o,e)),s.push(...at(t,o,e)),x(t,e,s),e},"Image"),D=c((t,o,r,e,s,i)=>{const n=document.createElementNS("http://www.w3.org/2000/svg","marker");n.setAttribute("id",t),n.setAttribute("markerUnits","strokeWidth"),n.setAttribute("markerWidth",_(e.width*s).toString()),n.setAttribute("markerHeight",_(e.height*s).toString()),n.setAttribute("viewBox",e.viewbox),n.setAttribute("refX",e.refX.toString()),n.setAttribute("refY",e.refY.toString()),i?n.setAttribute("orient","auto"):n.setAttribute("orient","auto-start-reverse");const a=document.createElementNS("http://www.w3.org/2000/svg","path");return a.setAttribute("d",e.path),e.fillKind==="stroke"?(a.setAttribute("fill","none"),n.setAttribute("stroke",o),n.setAttribute("stroke-opacity",r.toString())):(a.setAttribute("fill",o),a.setAttribute("fill-opacity",r.toString())),e.style&&Object.entries(e.style).forEach(([l,d])=>{a.setAttribute(l,d)}),n.appendChild(a),n},"arrowHead"),Pt=c((t,o,r)=>{const e=[],[s,i]=t.properties.start.contents,[n,a]=t.properties.end.contents,l=t.properties.startArrowheadSize.contents,d=t.properties.endArrowheadSize.contents,f=t.properties.strokeWidth.contents;e.push("start","end","startArrowhead","endArrowhead","startArrowheadSize","endArrowheadSize","strokeWidth");const p=Math.sqrt((s-n)**2+(i-a)**2);let g,u;if(o){const b=(t.properties.flipStartArrowhead.contents?o.refX:o.width-o.refX)*l*f,w=b/p*(s-n),k=b/p*(i-a);[g,u]=[s-w,i-k]}else[g,u]=[s,i];let m,v;if(r){const h=(r.width-r.refX)*d*f;[m,v]=[n-h/p*(n-s),a-h/p*(a-i)]}else[m,v]=[n,a];return[[[g,u],[m,v]],e]},"makeRoomForArrows"),qt=c(({shape:t,canvasSize:o,namespace:r,variation:e})=>{const s=$(t.properties.startArrowhead.contents),i=$(t.properties.endArrowhead.contents),[[[n,a],[l,d]],f]=Pt(t,s,i),[p,g]=M([n,a],o),[u,m]=M([l,d],o),v=`M ${p} ${g} L ${u} ${m}`,h=R(t.properties.strokeColor.contents),b=t.properties.strokeWidth.contents,w=O(t.properties.strokeColor.contents),k=document.createElementNS("http://www.w3.org/2000/svg","g"),S=`${r}-${e}`,y=S+"-startArrowId",L=S+"-endArrowId";if(s){const z=t.properties.startArrowheadSize.contents,T=t.properties.flipStartArrowhead.contents;k.appendChild(D(y,h,w,s,z,T))}if(i){const z=t.properties.endArrowheadSize.contents;k.appendChild(D(L,h,w,i,z,!1))}f.push("strokeColor","strokeWidth","startArrowhead","flipStartArrowhead","endArrowhead","startArrowheadSize","endArrowheadSize");const A=document.createElementNS("http://www.w3.org/2000/svg","path");return A.setAttribute("d",v),t.properties.strokeColor.contents.tag!=="NONE"&&(A.setAttribute("stroke-opacity",w.toString()),A.setAttribute("stroke-width",b.toString())),A.setAttribute("stroke",h),"strokeDasharray"in t.properties&&t.properties.strokeDasharray.contents!==""?A.setAttribute("stroke-dasharray",t.properties.strokeDasharray.contents):t.properties.strokeStyle.contents==="dashed"&&A.setAttribute("stroke-dasharray",q.toString()),f.push("strokeDasharray","strokeStyle"),"strokeLinecap"in t.properties&&t.properties.strokeLinecap.contents!==""?A.setAttribute("stroke-linecap",t.properties.strokeLinecap.contents):A.setAttribute("stroke-linecap","butt"),f.push("strokeLinecap"),s&&(A.setAttribute("marker-start",`url(#${y})`),f.push("startArrowhead")),i&&(A.setAttribute("marker-end",`url(#${L})`),f.push("endArrowhead")),k.appendChild(A),f.push(...C(t,k)),x(t,k,f),k},"Line"),Wt=c((t,o)=>t.map(r=>{const{cmd:e,contents:s}=r;if(s.length===0&&e!=="Z")return console.error("WARNING: empty path"),"";const i=At.flatten(s.map(n=>{switch(n.tag){case"CoordV":return M(n.contents,o);case"ValueV":return n.contents}})).join(" ");return`${e} ${i}`}).join(" "),"toPathString"),Xt=c(t=>{const o=document.createElementNS("http://www.w3.org/2000/svg","filter");return o.setAttribute("id",t),o.setAttribute("x","0"),o.setAttribute("y","0"),o.setAttribute("width","200%"),o.setAttribute("height","200%"),o.innerHTML=`
