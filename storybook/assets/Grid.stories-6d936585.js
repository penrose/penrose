var f=Object.defineProperty;var s=(t,e)=>f(t,"name",{value:e,configurable:!0});import{A as l}from"./index-e85d8290.js";import{s as a,F as y}from"./styled-components.browser.esm-e68be8f2.js";import{R as x,r as C}from"./index-74c5fbfa.js";import{G as v,p as S}from"./penroseBlue-4474e4d5.js";import{j as o}from"./jsx-runtime-9c5bc5e6.js";import{c as G}from"./PenrosePrograms-28ddb5f1.js";import"./es.object.get-own-property-descriptor-2f3bcc00.js";import"./web.url-1059d872.js";import"./index-b79ff3a9.js";import"./Simple-00d6b7a3.js";const P=a.main`
  flex-grow: 1;
  margin-left: "4rem";
`,b=a.div`
  display: flex;
...
`,locationsMap:{"continuous-map":{startLoc:{col:46,line:17},endLoc:{col:1,line:27},startBody:{col:46,line:17},endBody:{col:1,line:27}}}}},title:"Example/Grid Component",component:n},V=s(t=>o(y,{theme:S,children:o(n,{...t,header:e=>`Diagram ${e}`,metadata:e=>[{name:"Variation",data:t.diagrams[e].variation}]})}),"Template"),q=V.bind({});q.args={diagrams:l.range(10).map(t=>({...G,variation:`${t}`}))};const I=["ContinuousMap"];export{q as ContinuousMap,I as __namedExportsOrder,F as default};
//# sourceMappingURL=Grid.stories-6d936585.js.map
