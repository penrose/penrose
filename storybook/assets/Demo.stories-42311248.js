var u=Object.defineProperty;var a=(e,t)=>u(e,"name",{value:t,configurable:!0});import{r as m}from"./index-74c5fbfa.js";import{S as g}from"./Simple-6e5ad4b0.js";import{j as s}from"./jsx-runtime-9c5bc5e6.js";import{v as n,a as r}from"./PenrosePrograms-b82226b1.js";import"./es.object.get-own-property-descriptor-2f3bcc00.js";import"./CollectLabels-dd9b160a.js";import"./web.url-1059d872.js";const i=a(e=>{const[t,c]=m.useState(0);m.useEffect(()=>{const d=window.setInterval(()=>c(p=>(p+1)%e.examples.length),5e3);return()=>clearInterval(d)},[t]);const o=e.examples[t];return s("div",{style:{width:e.width,height:e.width},children:s(g,{name:"demo",substance:o.sub,style:o.sty,domain:o.dsl,variation:o.variation,interactive:!1,animate:!0})})},"Demo"),l=i;try{i.displayName="Demo",i.__docgenInfo={description:"",displayName:"Demo",props:{examples:{defaultValue:null,description:"",name:"examples",required:!0,type:{name:"{ sub: string; sty: string; dsl: string; variation: string; }[]"}},width:{defaultValue:null,description:"",name:"width",required:!0,type:{name:"string"}},darkMode:{defaultValue:null,description:"",name:"darkMode",required:!0,type:{name:"boolean"}}}}}catch{}const M={parameters:{storySource:{source:`import { ComponentMeta, ComponentStory } from "@storybook/react";
