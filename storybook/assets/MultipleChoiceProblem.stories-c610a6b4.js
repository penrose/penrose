import{s as ke,F as zi}from"./styled-components.browser.esm-f9fd8fa0.js";import{r as we,j as X0,a as An}from"./jsx-runtime-fa54a4ba.js";import{S as Bi,__tla as __tla_0}from"./Simple-a57acd4b.js";import"./index-5b359ca1.js";import"./hoist-non-react-statics.cjs-09a3cb37.js";import{__tla as __tla_1}from"./iframe-2edd0afa.js";import{__tla as __tla_2}from"./svg-8f79f423.js";let Xi,r1,t1;let __tla=Promise.all([(()=>{try{return __tla_0}catch{}})(),(()=>{try{return __tla_1}catch{}})(),(()=>{try{return __tla_2}catch{}})()]).then(async()=>{var Si=Object.defineProperty;var u=(L,H)=>Si(L,"name",{value:H,configurable:!0});const Ye=`Hydrogen h
Carbon c
Nitrogen n
...
`,Ui=u(({domain:L,style:H,substance:V,variation:W,index:P,answer:k,showAnswer:J,onSelect:w0,onDeselect:k0})=>{const[$0,j0]=we.useState(!1);return An(Pi,{checked:$0,answer:k,showAnswer:J,onClick:()=>{j0(Z0=>(Z0?k0(P):w0(P),!Z0))},children:[X0(Gi,{children:P+1}),X0(Bi,{name:`choice-${P}`,domain:L,style:H,substance:V,variation:W,interactive:!1,excludeWarnings:[]},`choice-${P}`)]})},"ProblemChoice");function zn(L){const[H,V]=we.useState(new Set),[W,P]=we.useState(!1),k=L.diagrams.map(({domain:J,style:w0,substance:k0,variation:$0,answer:j0},Z0)=>X0(Ui,{domain:J,style:w0,substance:k0,variation:$0,index:Z0,answer:j0,showAnswer:W,onSelect:ce=>{V(K0=>K0.add(ce)),P(!1)},onDeselect:ce=>V(K0=>(K0.delete(ce),P(!1),K0))},`problem-choice-${Z0}`));return An(Hi,{onClick:J=>J.stopPropagation(),children:[X0(Vi,{children:X0(Ii,{delimiters:[{right:"$",left:"$",display:!1}],children:L.prompt})}),k,X0(Wi,{onClick:()=>P(!0),children:"Check Answer"})]})}u(zn,"MultipleChoiceProblem$1");try{MultipleChoiceProblem.displayName="MultipleChoiceProblem",MultipleChoiceProblem.__docgenInfo={description:"",displayName:"MultipleChoiceProblem",props:{diagrams:{defaultValue:null,description:"",name:"diagrams",required:!0,type:{name:"DiagramOption[]"}},correctIndices:{defaultValue:null,description:"",name:"correctIndices",required:!0,type:{name:"number[]"}},prompt:{defaultValue:null,description:"",name:"prompt",required:!0,type:{name:"string"}}}}}catch{}let Yi;t1={parameters:{storySource:{source:`import substance from "@penrose/examples/dist/molecules/hydrogencyanide.substance";
