var yt=Object.defineProperty;var c=(t,r)=>yt(t,"name",{value:r,configurable:!0});import{g as F,t as O,b as R,c as M,d as wt,e as X,f as $,r as _,l as At,s as Y,h as vt,i as et,j as rt,k as ot,n as bt,o as St,m as xt,p as Mt,q as Ct,u as Et,w as Nt,x as st}from"./PenrosePrograms-e049439c.js";import{R as U}from"./index-74c5fbfa.js";import{j,a as B}from"./jsx-runtime-9c5bc5e6.js";const Lt=c((t,r,o,e)=>{const s=[...t.varyingValues],{constraintSets:i,optStages:n}=t,{inputMask:a,objMask:l,constrMask:d}=i.get(n[0]),m=[...a];for(const g of t.shapes)if(g.properties.name.contents===r)for(const u of zt(g,[o,e],s))m[u]=!1;return Object.assign(Object.assign({},t),{params:F(m,l,d),varyingValues:s})},"dragUpdate"),zt=c((t,r,o)=>{const{shapeType:e,properties:s}=t;switch(e){case"Path":return console.log("Path drag unimplemented",t),[];case"Polygon":return console.log("Polygon drag unimplemented",t),[];case"Polyline":return console.log("Polyline drag unimplemented",t),[];case"Line":return H(s,["start","end"],r,o);default:return H(s,["center"],r,o)}},"dragShape"),H=c((t,r,[o,e],s)=>{const i=[];for(const n of r){const a=t[n];if(a.tag==="VectorV"){const[l,d]=a.contents;typeof l!="number"&&l.tag==="Input"&&(s[l.key]+=o,i.push(l.key)),typeof d!="number"&&d.tag==="Input"&&(s[d.key]+=e,i.push(d.key))}}return i},"moveProperties"),Z={accentHeight:"accent-height",alignmentBaseline:"alignment-baseline",arabicForm:"arabic-form",baselineShift:"baseline-shift",capHeight:"cap-height",clipPath:"clip-path",clipRule:"clip-rule",colorInterpolation:"color-interpolation",colorInterpolationFilters:"color-interpolation-filters",colorProfile:"color-profile",colorRendering:"color-rendering",dominantBaseline:"dominant-baseline",enableBackground:"enable-background",fillOpacity:"fill-opacity",fillRule:"fill-rule",floodColor:"flood-color",floodOpacity:"flood-opacity",fontFamily:"font-family",fontSize:"font-size",fontSizeAdjust:"font-size-adjust",fontStretch:"font-stretch",fontStyle:"font-style",fontVariant:"font-variant",fontWeight:"font-weight",glyphName:"glyph-name",glyphOrientationHorizontal:"glyph-orientation-horizontal",glyphOrientationVertical:"glyph-orientation-vertical",horizAdvX:"horiz-adv-x",horizOriginX:"horiz-origin-x",imageRendering:"image-rendering",letterSpacing:"letter-spacing",lightingColor:"lighting-color",markerEnd:"marker-end",markerMid:"marker-mid",markerStart:"marker-start",overlinePosition:"overline-position",overlineThickness:"overline-thickness",panose1:"panose-1",paintOrder:"paint-order",pointerEvents:"pointer-events",renderingIntent:"rendering-intent",shapeRendering:"shape-rendering",stopColor:"stop-color",stopOpacity:"stop-opacity",strikethroughPosition:"strikethrough-position",strikethroughThickness:"strikethrough-thickness",strokeDasharray:"stroke-dasharray",strokeDashoffset:"stroke-dashoffset",strokeLinecap:"stroke-linecap",strokeLinejoin:"stroke-linejoin",strokeMiterlimit:"stroke-miterlimit",strokeOpacity:"stroke-opacity",strokeWidth:"stroke-width",textAnchor:"text-anchor",textDecoration:"text-decoration",textRendering:"text-rendering",transformOrigin:"transform-origin",underlinePosition:"underline-position",underlineThickness:"underline-thickness",unicodeBidi:"unicode-bidi",unicodeRange:"unicode-range",unitsPerEm:"units-per-em",vAlphabetic:"v-alphabetic",vHanging:"v-hanging",vIdeographic:"v-ideographic",vMathematical:"v-mathematical",vectorEffect:"vector-effect",vertAdvY:"vert-adv-y",vertOriginX:"vert-origin-x",vertOriginY:"vert-origin-y",wordSpacing:"word-spacing",writingMode:"writing-mode"},x=c(({properties:t},r,o)=>{const e=["strokeStyle","name","ensureOnCanvas"],s=new Set(o.concat(e));for(const i in t){const n=t[i].contents.toString();if(n!==""&&!s.has(i))if(i in Z){const a=Z[i];r.hasAttribute(a)||r.setAttribute(a,n)}else if(i==="style"&&n!==""){const a=r.getAttribute(i);a===null?r.setAttribute(i,n):r.setAttribute(i,`${a}${n}`)}else r.hasAttribute(i)||r.setAttribute(i,n)}},"attrAutoFillSvg"),E=c(({properties:t},r)=>{const o=t.fillColor,e=O(o.contents);return r.setAttribute("fill",R(o.contents)),o.contents.tag!=="NONE"&&r.setAttribute("fill-opacity",e.toString()),["fillColor"]},"attrFill"),nt=c(({properties:t},r,o)=>{const e=t.center,[s,i]=M(e.contents,r);return o.setAttribute("cx",s.toString()),o.setAttribute("cy",i.toString()),["center"]},"attrCenter"),it=c(({properties:t},r)=>{let o=t.scale.contents;o=o||1;let e=r.getAttribute("transform");return e=e===null?`scale(${o})`:e+`scale{${o}}`,r.setAttribute("transform",e),["scale"]},"attrScale"),at=c(({properties:t},r,o)=>{const e=t.center,[s,i]=M(e.contents,r),n=t.width,a=t.height;let l=o.getAttribute("transform");return l=l===null?`translate(${s-n.contents/2}, ${i-a.contents/2})`:l+`translate(${s-n.contents/2}, ${i-a.contents/2})`,o.setAttribute("transform",l),["center","width","height"]},"attrTransformCoords"),jt=c(({properties:t},r,o)=>{const e=t.center,[s,i]=M(e.contents,r),n=t.width,a=t.height;return o.setAttribute("x",(s-n.contents/2).toString()),o.setAttribute("y",(i-a.contents/2).toString()),["center","width","height"]},"attrXY"),G=c(({properties:t},r,o)=>{const e=t.width,s=t.height,i=t.center,n=t.rotation.contents,[a,l]=M(i.contents,r);let d=o.getAttribute("transform");return d=d===null?`rotate(${n}, ${a-e.contents/2}, ${l-s.contents/2})`:d+`rotate(${n}, ${a-e.contents/2}, ${l-s.contents/2})`,o.setAttribute("transform",d),["rotation","center","width","height"]},"attrRotation"),I=c(({properties:t},r)=>{const o=t.width,e=t.height;return r.setAttribute("width",o.contents.toString()),r.setAttribute("height",e.contents.toString()),["width","height"]},"attrWH"),Ot=c(({properties:t},r)=>{const o=t.cornerRadius;return r.setAttribute("rx",o.contents.toString()),["cornerRadius"]},"attrCornerRadius"),Rt=c(({properties:t},r)=>{const o=t.string,e=document.createTextNode(o.contents.toString());return r.appendChild(e),["string"]},"attrString"),q="7,5",N=c(({properties:t},r)=>{const o=[],e=t.strokeColor,s=O(e.contents),i=t.strokeWidth.contents;return r.setAttribute("stroke",R(e.contents)),o.push("strokeColor","strokeWidth"),e.contents.tag!=="NONE"&&(r.setAttribute("stroke-opacity",s.toString()),r.setAttribute("stroke-width",i.toString()),"strokeDasharray"in t&&t.strokeDasharray.contents!==""?r.setAttribute("stroke-dasharray",t.strokeDasharray.contents):"strokeStyle"in t&&t.strokeStyle.contents==="dashed"&&(r.setAttribute("stroke-dasharray",q.toString()),o.push("strokeDasharray","strokeStyle")),"strokeLinecap"in t&&t.strokeLinecap.contents!==""?r.setAttribute("stroke-linecap",t.strokeLinecap.contents):r.setAttribute("stroke-linecap","butt"),o.push("strokeLinecap")),o},"attrStroke"),C=c(({properties:t},r)=>{const o=t.name,e=document.createElementNS("http://www.w3.org/2000/svg","title");return e.textContent=o.contents,r.appendChild(e),["name"]},"attrTitle"),ct=c((t,r)=>{const o=wt(t),e=r.getAttribute("style");return r.setAttribute("style",e?`${e}; font: ${o};`:`font: ${o};`),["fontFamily","fontSize","fontStretch","fontStyle","fontVariant","fontWeight","lineHeigh"]},"attrFont"),lt=c((t,r,o)=>{const s=t.properties.points.contents.map(i=>M(i,r));return o.setAttribute("points",s.toString()),["points"]},"attrPolyPoints"),It=c(({shape:t,canvasSize:r})=>{const o=document.createElementNS("http://www.w3.org/2000/svg","circle"),e=[];return e.push(...E(t,o)),e.push(...nt(t,r,o)),e.push(...N(t,o)),e.push(...C(t,o)),x(t,o,e),o},"Circle"),Tt=c(({shape:t,canvasSize:r})=>{const o=document.createElementNS("http://www.w3.org/2000/svg","ellipse"),e=[];return e.push(...E(t,o)),e.push(...nt(t,r,o)),e.push(...N(t,o)),e.push(...C(t,o)),x(t,o,e),o},"Ellipse"),$t=c(({shape:t,canvasSize:r,labels:o})=>{const e=document.createElementNS("http://www.w3.org/2000/svg","g"),s=[];s.push(...G(t,r,e)),s.push(...at(t,r,e)),s.push(...C(t,e));let i=!1;const n=o.get(X(t.properties.name));if(n&&n.tag==="EquationData"){const a=n.rendered.cloneNode(!0),l=a.getElementsByTagName("g")[0];s.push(...E(t,l)),s.push(...I(t,a)),l.setAttribute("stroke","none"),l.setAttribute("stroke-width","0");const d=t.properties.fontSize;a.setAttribute("style",`font-size: ${d.contents}`),e.appendChild(a),i=!0}if(!i){const a=document.createElementNS("http://www.w3.org/2000/svg","text");a.textContent=X(t.properties.string),s.push("string"),e.appendChild(a),s.push(...E(t,e)),s.push(...I(t,e)),s.push(...N(t,e)),s.push(...ct(t,e))}return x(t,e,s),e},"Equation"),Dt=`<?xml version='1.0' encoding='UTF-8' standalone='no'?>
...
</svg>`;let Vt=1;const Gt=c((t,r)=>{const o="--inject-",e={clipPath:["clip-path"],"color-profile":null,cursor:null,filter:null,linearGradient:["fill","stroke"],marker:["marker","marker-end","marker-mid","marker-start"],mask:null,pattern:["fill","stroke"],radialGradient:["fill","stroke"]},s=o+Vt++,i=/url\("?#([a-zA-Z][\w:.-]*)"?\)/g,n=t.querySelectorAll("[id]");let a;const l=r?[]:null;let d;const m={},p=[];let g=!1,u,f;if(n.length){for(u=0;u<n.length;u++)d=n[u].localName,d in e&&(m[d]=1);for(d in m)(e[d]||[d]).forEach(function(S){p.indexOf(S)<0&&p.push(S)});p.length&&p.push("style");const v=t.getElementsByTagName("*");let h=t,b,w,k;for(u=-1;h!==null;){if(h.localName==="style")w=h.textContent,k=w&&w.replace(i,function(S,y){return l&&(l[y]=1),"url(#"+y+s+")"}),k!==w&&(h.textContent=k);else if(h.hasAttributes()){for(f=0;f<p.length;f++)b=p[f],w=h.getAttribute(b),k=w&&w.replace(i,function(S,y){return l&&(l[y]=1),"url(#"+y+s+")"}),k&&k!==w&&h.setAttribute(b,k);for(const S of["xlink:href","href"]){let y=h.getAttribute(S);y&&/^\s*#/.test(y)&&(y=y.trim(),h.setAttribute(S,y+s),l&&(l[y.substring(1)]=1))}}h=v.item(++u)}for(u=0;u<n.length;u++)a=n[u],(!l||l[a.id])&&(a.id+=s,g=!0)}return g},"makeIdsUnique"),Pt=c(async({shape:t,canvasSize:r,pathResolver:o})=>{const e=document.createElementNS("http://www.w3.org/2000/svg","g"),s=[],i=t.properties.href.contents;let n=await o(i);n===void 0&&(console.error(`Could not resolve image path ${i}`),n=Dt),s.push("href"),e.innerHTML=n;const a=e.querySelector("svg");return Gt(e,!1),s.push(...I(t,a)),s.push(...G(t,r,e)),s.push(...at(t,r,e)),x(t,e,s),e},"Image"),D=c((t,r,o,e,s,i)=>{const n=document.createElementNS("http://www.w3.org/2000/svg","marker");n.setAttribute("id",t),n.setAttribute("markerUnits","strokeWidth"),n.setAttribute("markerWidth",_(e.width*s).toString()),n.setAttribute("markerHeight",_(e.height*s).toString()),n.setAttribute("viewBox",e.viewbox),n.setAttribute("refX",e.refX.toString()),n.setAttribute("refY",e.refY.toString()),i?n.setAttribute("orient","auto"):n.setAttribute("orient","auto-start-reverse");const a=document.createElementNS("http://www.w3.org/2000/svg","path");return a.setAttribute("d",e.path),e.fillKind==="stroke"?(a.setAttribute("fill","none"),n.setAttribute("stroke",r),n.setAttribute("stroke-opacity",o.toString())):(a.setAttribute("fill",r),a.setAttribute("fill-opacity",o.toString())),e.style&&Object.entries(e.style).forEach(([l,d])=>{a.setAttribute(l,d)}),n.appendChild(a),n},"arrowHead"),Ft=c((t,r,o)=>{const e=[],[s,i]=t.properties.start.contents,[n,a]=t.properties.end.contents,l=t.properties.startArrowheadSize.contents,d=t.properties.endArrowheadSize.contents,m=t.properties.strokeWidth.contents;e.push("start","end","startArrowhead","endArrowhead","startArrowheadSize","endArrowheadSize","strokeWidth");const p=Math.sqrt((s-n)**2+(i-a)**2);let g,u;if(r){const b=(t.properties.flipStartArrowhead.contents?r.refX:r.width-r.refX)*l*m,w=b/p*(s-n),k=b/p*(i-a);[g,u]=[s-w,i-k]}else[g,u]=[s,i];let f,v;if(o){const h=(o.width-o.refX)*d*m;[f,v]=[n-h/p*(n-s),a-h/p*(a-i)]}else[f,v]=[n,a];return[[[g,u],[f,v]],e]},"makeRoomForArrows"),qt=c(({shape:t,canvasSize:r,namespace:o,variation:e})=>{const s=$(t.properties.startArrowhead.contents),i=$(t.properties.endArrowhead.contents),[[[n,a],[l,d]],m]=Ft(t,s,i),[p,g]=M([n,a],r),[u,f]=M([l,d],r),v=`M ${p} ${g} L ${u} ${f}`,h=R(t.properties.strokeColor.contents),b=t.properties.strokeWidth.contents,w=O(t.properties.strokeColor.contents),k=document.createElementNS("http://www.w3.org/2000/svg","g"),S=`${o}-${e}`,y=S+"-startArrowId",L=S+"-endArrowId";if(s){const z=t.properties.startArrowheadSize.contents,T=t.properties.flipStartArrowhead.contents;k.appendChild(D(y,h,w,s,z,T))}if(i){const z=t.properties.endArrowheadSize.contents;k.appendChild(D(L,h,w,i,z,!1))}m.push("strokeColor","strokeWidth","startArrowhead","flipStartArrowhead","endArrowhead","startArrowheadSize","endArrowheadSize");const A=document.createElementNS("http://www.w3.org/2000/svg","path");return A.setAttribute("d",v),t.properties.strokeColor.contents.tag!=="NONE"&&(A.setAttribute("stroke-opacity",w.toString()),A.setAttribute("stroke-width",b.toString())),A.setAttribute("stroke",h),"strokeDasharray"in t.properties&&t.properties.strokeDasharray.contents!==""?A.setAttribute("stroke-dasharray",t.properties.strokeDasharray.contents):t.properties.strokeStyle.contents==="dashed"&&A.setAttribute("stroke-dasharray",q.toString()),m.push("strokeDasharray","strokeStyle"),"strokeLinecap"in t.properties&&t.properties.strokeLinecap.contents!==""?A.setAttribute("stroke-linecap",t.properties.strokeLinecap.contents):A.setAttribute("stroke-linecap","butt"),m.push("strokeLinecap"),s&&(A.setAttribute("marker-start",`url(#${y})`),m.push("startArrowhead")),i&&(A.setAttribute("marker-end",`url(#${L})`),m.push("endArrowhead")),k.appendChild(A),m.push(...C(t,k)),x(t,k,m),k},"Line"),Wt=c((t,r)=>t.map(o=>{const{cmd:e,contents:s}=o;if(s.length===0&&e!=="Z")return console.error("WARNING: empty path"),"";const i=At.flatten(s.map(n=>{switch(n.tag){case"CoordV":return M(n.contents,r);case"ValueV":return n.contents}})).join(" ");return`${e} ${i}`}).join(" "),"toPathString"),Xt=c(t=>{const r=document.createElementNS("http://www.w3.org/2000/svg","filter");return r.setAttribute("id",t),r.setAttribute("x","0"),r.setAttribute("y","0"),r.setAttribute("width","200%"),r.setAttribute("height","200%"),r.innerHTML=`
