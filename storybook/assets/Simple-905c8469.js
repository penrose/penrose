var ft=Object.defineProperty;var c=(t,o)=>ft(t,"name",{value:o,configurable:!0});import{t as j,a as I,b as C,c as ht,g as F,d as X,e as T,r as Y,_ as gt,i as mt,f as yt,h as kt,s as wt,j as Q,k as tt,l as At,n as et,o as St,p as bt,q as vt,u as xt,v as Mt,w as Ct,x as Et,y as ot}from"./index-12f33557.js";import{R as B}from"./index-74c5fbfa.js";import{j as L,a as U}from"./jsx-runtime-9c5bc5e6.js";const P={accentHeight:"accent-height",alignmentBaseline:"alignment-baseline",arabicForm:"arabic-form",baselineShift:"baseline-shift",capHeight:"cap-height",clipPath:"clip-path",clipRule:"clip-rule",colorInterpolation:"color-interpolation",colorInterpolationFilters:"color-interpolation-filters",colorProfile:"color-profile",colorRendering:"color-rendering",dominantBaseline:"dominant-baseline",enableBackground:"enable-background",fillOpacity:"fill-opacity",fillRule:"fill-rule",floodColor:"flood-color",floodOpacity:"flood-opacity",fontFamily:"font-family",fontSize:"font-size",fontSizeAdjust:"font-size-adjust",fontStretch:"font-stretch",fontStyle:"font-style",fontVariant:"font-variant",fontWeight:"font-weight",glyphName:"glyph-name",glyphOrientationHorizontal:"glyph-orientation-horizontal",glyphOrientationVertical:"glyph-orientation-vertical",horizAdvX:"horiz-adv-x",horizOriginX:"horiz-origin-x",imageRendering:"image-rendering",letterSpacing:"letter-spacing",lightingColor:"lighting-color",markerEnd:"marker-end",markerMid:"marker-mid",markerStart:"marker-start",overlinePosition:"overline-position",overlineThickness:"overline-thickness",panose1:"panose-1",paintOrder:"paint-order",pointerEvents:"pointer-events",renderingIntent:"rendering-intent",shapeRendering:"shape-rendering",stopColor:"stop-color",stopOpacity:"stop-opacity",strikethroughPosition:"strikethrough-position",strikethroughThickness:"strikethrough-thickness",strokeDasharray:"stroke-dasharray",strokeDashoffset:"stroke-dashoffset",strokeLinecap:"stroke-linecap",strokeLinejoin:"stroke-linejoin",strokeMiterlimit:"stroke-miterlimit",strokeOpacity:"stroke-opacity",strokeWidth:"stroke-width",textAnchor:"text-anchor",textDecoration:"text-decoration",textRendering:"text-rendering",transformOrigin:"transform-origin",underlinePosition:"underline-position",underlineThickness:"underline-thickness",unicodeBidi:"unicode-bidi",unicodeRange:"unicode-range",unitsPerEm:"units-per-em",vAlphabetic:"v-alphabetic",vHanging:"v-hanging",vIdeographic:"v-ideographic",vMathematical:"v-mathematical",vectorEffect:"vector-effect",vertAdvY:"vert-adv-y",vertOriginX:"vert-origin-x",vertOriginY:"vert-origin-y",wordSpacing:"word-spacing",writingMode:"writing-mode"},x=c((t,o,r)=>{const e=["strokeStyle","name","ensureOnCanvas"],n=new Set(r.concat(e));for(const[i,s]of t.passthrough)if(!(s.tag==="StrV"&&s.contents===""||n.has(i)))if(i in P){const a=P[i];if(!o.hasAttribute(a))o.setAttribute(a,s.contents.toString());else if(i==="style"){const l=o.getAttribute(i);l===null?o.setAttribute(i,s.contents.toString()):o.setAttribute(i,`${l}${s.contents.toString()}`)}else o.hasAttribute(i)||o.setAttribute(i,s.contents.toString())}else o.setAttribute(i,s.contents.toString())},"attrAutoFillSvg"),E=c((t,o)=>{const r=t.fillColor,e=j(r.contents);return o.setAttribute("fill",I(r.contents)),r.contents.tag!=="NONE"&&o.setAttribute("fill-opacity",e.toString()),["fillColor"]},"attrFill"),rt=c((t,o,r)=>{const e=t.center,[n,i]=C([e.contents[0],e.contents[1]],o);return r.setAttribute("cx",n.toString()),r.setAttribute("cy",i.toString()),["center"]},"attrCenter"),nt=c((t,o)=>{let r=t.scale.contents;r=r||1;let e=o.getAttribute("transform");return e=e===null?`scale(${r})`:e+`scale{${r}}`,o.setAttribute("transform",e),["scale"]},"attrScale"),st=c((t,o,r)=>{const e=t.center,[n,i]=C([e.contents[0],e.contents[1]],o),s=t.width,a=t.height;let l=r.getAttribute("transform");return l=l===null?`translate(${n-s.contents/2}, ${i-a.contents/2})`:l+`translate(${n-s.contents/2}, ${i-a.contents/2})`,r.setAttribute("transform",l),["center","width","height"]},"attrTransformCoords"),Lt=c((t,o,r)=>{const e=t.center,[n,i]=C([e.contents[0],e.contents[1]],o),s=t.width,a=t.height;return r.setAttribute("x",(n-s.contents/2).toString()),r.setAttribute("y",(i-a.contents/2).toString()),["center","width","height"]},"attrXY"),V=c((t,o,r)=>{t.width,t.height;const e=t.center,n=t.rotation.contents,[i,s]=C([e.contents[0],e.contents[1]],o);let a=r.getAttribute("transform");return a=a===null?`rotate(${n}, ${i}, ${s})`:a+`rotate(${n}, ${i}, ${s})`,r.setAttribute("transform",a),["rotation","center","width","height"]},"attrRotation"),O=c((t,o)=>{const r=t.width,e=t.height;return o.setAttribute("width",r.contents.toString()),o.setAttribute("height",e.contents.toString()),["width","height"]},"attrWH"),Rt=c((t,o)=>{const r=t.cornerRadius;return o.setAttribute("rx",r.contents.toString()),["cornerRadius"]},"attrCornerRadius"),Nt=c((t,o)=>{const r=t.string,e=document.createTextNode(r.contents.toString());return o.appendChild(e),["string"]},"attrString"),W="7,5",R=c((t,o)=>{const r=[],e=t.strokeColor,n=j(e.contents),i=t.strokeWidth.contents;return o.setAttribute("stroke",I(e.contents)),r.push("strokeColor","strokeWidth"),e.contents.tag!=="NONE"&&(o.setAttribute("stroke-opacity",n.toString()),o.setAttribute("stroke-width",i.toString()),"strokeDasharray"in t&&t.strokeDasharray.contents!==""?o.setAttribute("stroke-dasharray",t.strokeDasharray.contents):"strokeStyle"in t&&t.strokeStyle.contents==="dashed"&&(o.setAttribute("stroke-dasharray",W.toString()),r.push("strokeDasharray","strokeStyle")),"strokeLinecap"in t&&t.strokeLinecap.contents!==""?o.setAttribute("stroke-linecap",t.strokeLinecap.contents):o.setAttribute("stroke-linecap","butt"),r.push("strokeLinecap")),r},"attrStroke"),M=c((t,o)=>{const r=t.name,e=document.createElementNS("http://www.w3.org/2000/svg","title");return e.textContent=r.contents,o.appendChild(e),["name"]},"attrTitle"),zt=c((t,o)=>{const r=ht(t),e=o.getAttribute("style");return o.setAttribute("style",e?`${e}; font: ${r};`:`font: ${r};`),["fontFamily","fontSize","fontStretch","fontStyle","fontVariant","fontWeight","lineHeigh"]},"attrFont"),it=c((t,o,r)=>{const n=t.points.contents.map(i=>C([i[0],i[1]],o));return r.setAttribute("points",n.toString()),["points"]},"attrPolyPoints"),jt=c((t,{canvasSize:o})=>{const r=document.createElementNS("http://www.w3.org/2000/svg","circle"),e=[];return e.push(...E(t,r)),e.push(...rt(t,o,r)),e.push(...R(t,r)),e.push(...M(t,r)),r.setAttribute("r",t.r.contents.toString()),e.push("r"),x(t,r,e),r},"RenderCircle"),It=c((t,o,r,e)=>{const n=[...t.varyingValues],{constraintSets:i,optStages:s}=t,{inputMask:a,objMask:l,constrMask:d}=i.get(s[0]),h=[...a];for(const y of t.shapes)if(y.name.contents===o)for(const u of Ot(y,[r,e],n))h[u]=!1;return Object.assign(Object.assign({},t),{params:F(h,l,d),varyingValues:n})},"dragUpdate"),Ot=c((t,o,r)=>{switch(t.shapeType){case"Path":return console.log("Path drag unimplemented",t),[];case"Polygon":return console.log("Polygon drag unimplemented",t),[];case"Polyline":return console.log("Polyline drag unimplemented",t),[];case"Line":return H(t,["start","end"],o,r);default:return H(t,["center"],o,r)}},"dragShape"),H=c((t,o,[r,e],n)=>{const i=[];for(const s of o){const a=t[s];if(a.tag==="VectorV"){const[l,d]=a.contents;typeof l!="number"&&l.tag==="Input"&&(n[l.key]+=r,i.push(l.key)),typeof d!="number"&&d.tag==="Input"&&(n[d.key]+=e,i.push(d.key))}}return i},"moveProperties"),Tt=c((t,{canvasSize:o})=>{const r=document.createElementNS("http://www.w3.org/2000/svg","ellipse"),e=[];return e.push(...E(t,r)),e.push(...rt(t,o,r)),e.push(...R(t,r)),e.push(...M(t,r)),r.setAttribute("rx",t.rx.contents.toString()),e.push("rx"),r.setAttribute("ry",t.ry.contents.toString()),e.push("ry"),x(t,r,e),r},"RenderEllipse"),$t=c((t,{canvasSize:o,labels:r})=>{const e=document.createElementNS("http://www.w3.org/2000/svg","g"),n=[];n.push(...V(t,o,e)),n.push(...st(t,o,e)),n.push(...M(t,e));let i=!1;const s=r.get(X(t.name));if(s&&s.tag==="EquationData"){const a=s.rendered.cloneNode(!0),l=a.getElementsByTagName("g")[0];n.push(...E(t,l)),n.push(...O(t,a)),l.setAttribute("stroke","none"),l.setAttribute("stroke-width","0");const d=t.fontSize;a.setAttribute("style",`font-size: ${d.contents}`),e.appendChild(a),i=!0}if(!i){const a=document.createElementNS("http://www.w3.org/2000/svg","text");a.textContent=X(t.string),n.push("string"),e.appendChild(a),n.push(...E(t,e)),n.push(...O(t,e))}return x(t,e,n),e},"RenderEquation"),Dt=`<?xml version='1.0' encoding='UTF-8' standalone='no'?>
...
<svg
 ...
 viewBox='0 0 300 300'  version='1.0'
  ...
  <g
    ...
    `,o},"Shadow"),Yt=c((t,{canvasSize:o})=>{const r=t.name.contents+"-startArrowId",e=t.name.contents+"-endArrowId",n=t.name.contents+"-shadow",i=document.createElementNS("http://www.w3.org/2000/svg","g"),s=t.strokeWidth.contents,a=I(t.strokeColor.contents),l=j(t.strokeColor.contents),d=I(t.fillColor.contents),h=j(t.fillColor.contents),p=[],y=T(t.startArrowhead.contents),u=T(t.endArrowhead.contents);if(y){const S=t.name.contents+"-startArrowId",g=t.startArrowheadSize.contents,v=t.flipStartArrowhead.contents;i.appendChild($(S,a,l,y,g,v))}if(u){const S=t.name.contents+"-endArrowId",g=t.endArrowheadSize.contents;i.appendChild($(S,a,l,u,g,!1))}p.push("name","strokeColor","startArrowhead","flipStartArrowhead","endArrowhead"),i.appendChild(Xt(n));const f=document.createElementNS("http://www.w3.org/2000/svg","path");return f.setAttribute("stroke",a),f.setAttribute("fill",d),p.push("fillColor","strokeColor"),t.strokeColor.contents.tag!=="NONE"&&(f.setAttribute("stroke-width",s.toString()),f.setAttribute("stroke-opacity",l.toString()),p.push("strokeColor","strokeWidth")),t.fillColor.contents.tag!=="NONE"&&(f.setAttribute("fill-opacity",h.toString()),p.push("fillColor")),"strokeDasharray"in t&&t.strokeDasharray.contents!==""?f.setAttribute("stroke-dasharray",t.strokeDasharray.contents):t.strokeStyle.contents==="dashed"&&f.setAttribute("stroke-dasharray",W.toString()),p.push("strokeDasharray","strokeStyle"),f.setAttribute("d",_t(t.d.contents,o)),p.push("d"),y&&(f.setAttribute("marker-start",`url(#${r})`),p.push("startArrowhead")),u&&(f.setAttribute("marker-end",`url(#${e})`),p.push("endArrowhead")),i.appendChild(f),p.push(...M(t,i)),x(t,i,p),i},"RenderPath"),Bt=c((t,{canvasSize:o})=>{const r=document.createElementNS("http://www.w3.org/2000/svg","polygon"),e=[];return e.push(...E(t,r)),e.push(...R(t,r)),e.push(...M(t,r)),e.push(...nt(t,r)),e.push(...it(t,o,r)),x(t,r,e),r},"RenderPolygon"),Ut=c((t,{canvasSize:o})=>{const r=document.createElementNS("http://www.w3.org/2000/svg","polyline"),e=[];return e.push(...E(t,r)),e.push(...R(t,r)),e.push(...M(t,r)),e.push(...nt(t,r)),e.push(...it(t,o,r)),x(t,r,e),r},"RenderPolyline"),Pt=c((t,{canvasSize:o})=>{const r=document.createElementNS("http://www.w3.org/2000/svg","rect"),e=[];return e.push(...Lt(t,o,r)),e.push(...O(t,r)),e.push(...E(t,r)),e.push(...R(t,r)),e.push(...M(t,r)),e.push(...Rt(t,r)),e.push(...V(t,o,r)),x(t,r,e),r},"RenderRectangle"),Ht=c((t,{canvasSize:o,labels:r})=>{const e=document.createElementNS("http://www.w3.org/2000/svg","text"),n=[];n.push("x","y"),n.push(...E(t,e)),n.push(...R(t,e)),n.push(...M(t,e)),n.push(...Nt(t,e)),n.push(...V(t,o,e)),n.push(...zt(t,e));const i=t.name,s=r.get(i.contents),a=t.center,[l,d]=C([a.contents[0],a.contents[1]],o);if(s&&s.tag==="TextData"){const h=s.descent.contents,p=s.height.contents,y=d+(p/2-h);e.setAttribute("x",l.toString()),e.setAttribute("y",y.toString()),n.push(...O(t,e))}else e.setAttribute("x",l.toString()),e.setAttribute("y",d.toString());return e.setAttribute("font-size-adjust",t.fontSizeAdjust.contents),e.setAttribute("alignment-baseline",t.alignmentBaseline.contents),e.setAttribute("dominant-baseline",t.dominantBaseline.contents),e.setAttribute("ascent",t.ascent.contents.toString()),e.setAttribute("descent",t.descent.contents.toString()),e.setAttribute("text-anchor",t.textAnchor.contents.toString()),e.setAttribute("visibility",t.visibility.contents),n.push("fontSizeAdjust","alignmentBaseline","dominantBaseline","ascent","descent","textAnchor","visibility"),x(t,e,n),e},"RenderText"),K=c(({clientX:t,clientY:o},r)=>{const e=r.getScreenCTM();return e!==null?{x:(t-e.e)/e.a,y:(o-e.f)/e.d}:{x:0,y:0}},"getPosition"),Kt=c(async(t,o,r,e)=>{const n=document.createElementNS("http://www.w3.org/2000/svg","svg");n.setAttribute("xmlns","http://www.w3.org/2000/svg"),n.setAttribute("width","100%"),n.setAttribute("height","100%"),n.setAttribute("version","1.2"),n.setAttribute("viewBox",`0 0 ${t.canvas.width} ${t.canvas.height}`);const i=c((a,l,d)=>{o(It(t,a,l,d))},"onDrag"),s=t.computeShapes(t.varyingValues);return await ct(s,n,{labels:t.labelCache,canvasSize:t.canvas.size,variation:t.variation,namespace:e,pathResolver:r},{updateState:o,onDrag:i,parentSVG:n}),n},"RenderInteractive"),Zt=c(async(t,o,r)=>{const{varyingValues:e,computeShapes:n,labelCache:i,canvas:s,variation:a}=t,l=document.createElementNS("http://www.w3.org/2000/svg","svg");l.setAttribute("version","1.2"),l.setAttribute("xmlns","http://www.w3.org/2000/svg"),l.setAttribute("viewBox",`0 0 ${s.width} ${s.height}`);const d=n(e);return await ct(d,l,{labels:i,canvasSize:s.size,variation:a,namespace:r,pathResolver:o},void 0),l},"RenderStatic"),Jt=c(async(t,o,r)=>{const e=document.createElementNS("http://www.w3.org/2000/svg","g"),n=kt(t.shapes);for(const i of n){const s=await at(i,o,r);e.appendChild(s)}return x(t,e,[...M(t,e),"shapes"]),e},"RenderGroup"),Qt=c(async(t,o)=>{switch(t.shapeType){case"Circle":return jt(t,o);case"Ellipse":return Tt(t,o);case"Equation":return $t(t,o);case"Image":return qt(t,o);case"Line":return Wt(t,o);case"Path":return Yt(t,o);case"Polygon":return Bt(t,o);case"Polyline":return Ut(t,o);case"Rectangle":return Pt(t,o);case"Text":return Ht(t,o)}},"RenderShapeSvg"),at=c(async(t,o,r)=>{if(t.shapeType==="Group")return await Jt(t,o,r);{const e=await Qt(t,o);if(r){const n=document.createElementNS("http://www.w3.org/2000/svg","g");mt(t)?n.setAttribute("pointer-events","visibleStroke"):yt(t)?n.setAttribute("pointer-events","bounding-box"):n.setAttribute("pointer-events","auto"),n.appendChild(e);const i=c(s=>{const{clientX:a,clientY:l}=s,{x:d,y:h}=K({clientX:a,clientY:l},r.parentSVG),{width:p,height:y,x:u,y:f}=s.target.getBBox({stroke:!0}),S=d-u,g=o.canvasSize[0]-p+(d-u),v=h-f,w=o.canvasSize[1]-y+(h-f);n.setAttribute("opacity","0.5");let m=0,A=0;const k=c(b=>{const{x:z,y:G}=K(b,r.parentSVG),pt=Z(z,S,g),ut=Z(G,v,w);m=pt-d,A=h-ut,n.setAttribute("transform",`translate(${m},${-A})`)},"onMouseMove"),N=c(()=>{n.setAttribute("opacity","1"),document.removeEventListener("mouseup",N),document.removeEventListener("mousemove",k),r.onDrag(t.name.contents,m,A)},"onMouseUp");document.addEventListener("mouseup",N),document.addEventListener("mousemove",k)},"onMouseDown");return n.addEventListener("mousedown",i),n}else return e}},"RenderShape"),ct=c(async(t,o,r,e)=>{for(const n of t){const i=await at(n,r,e);o.appendChild(i)}},"RenderShapes"),Z=c((t,o,r)=>Math.min(Math.max(t,o),r),"clamp"),te=c(t=>{const o=wt(t.variation),{constraintSets:r,optStages:e}=t,{inputMask:n,objMask:i,constrMask:s}=Q(r.get(e[0]),"missing first stage");return tt(Object.assign(Object.assign({},t),{varyingValues:t.inputs.map(a=>a.init.tag==="Sampled"?a.init.sampler(o):a.init.pending),currentStageIndex:0,params:F(n,i,s)}))},"resample"),lt=c((t,o=1e4)=>{const r=Object.assign(Object.assign({},t),At(t,t.gradient.f,o));return D(r)&&!_(r)?dt(r):r},"stepState"),dt=c(t=>{if(_(t))return t;{const{constraintSets:o,optStages:r,currentStageIndex:e}=t,n=r[e+1],{inputMask:i,objMask:s,constrMask:a}=Q(o.get(n),"missing next stage");return Object.assign(Object.assign({},t),{currentStageIndex:e+1,params:F(i,s,a)})}},"nextStage"),ee=c((t,o=1e4)=>{let r=t;for(;r.params.optStatus!=="Error"&&(!D(r)||!_(r));)D(r)&&(r=dt(r)),r=lt(r,o);return r.params.optStatus==="Error"?et(Object.assign({errorType:"RuntimeError"},St("",r))):bt(r)},"stepUntilConvergence"),oe=c(async t=>{const o=vt(t.domain),r=xt(n=>Mt(t.substance,n),o);return r.isErr()?et(r.error):await Ct(t.variation,t.style,...r.value)},"compileTrio"),re=c(async t=>{const o=await Et(t.shapes);if(o.isErr())throw Error(ot(o.error));return tt(Object.assign(Object.assign({},t),{labelCache:o.value}))},"prepareState"),D=c(t=>t.params.optStatus==="EPConverged","stateConverged"),_=c(t=>t.currentStageIndex===t.optStages.length-1,"finalStage");async function J(t){const o=await fetch(t);if(!o.ok){console.error(`could not fetch ${t}`);return}return await o.text()}c(J,"fetchResolver");class q extends B.Component{canvasRef=B.createRef();penroseState=void 0;timerID=void 0;constructor(o){super(o),this.state={error:void 0}}compile=async()=>{this.penroseState=void 0,this.setState({error:void 0});const o=await oe(this.props);o.isOk()?(this.penroseState=await re(o.value),this.setState({error:void 0})):this.setState({error:o.error})};converge=async()=>{if(this.penroseState){const o=ee(this.penroseState);o.isOk()?this.penroseState=o.value:this.setState({error:o.error})}};tick=()=>{this.props.animate&&this.penroseState&&!D(this.penroseState)&&(this.penroseState=lt(this.penroseState,this.props.stepSize??1),this.renderCanvas())};componentDidMount=async()=>{await this.compile(),this.props.animate||await this.converge(),this.renderCanvas(),this.timerID=window.setInterval(()=>this.tick(),1e3/60)};componentDidUpdate=async o=>{if(this.props.domain!==o.domain||this.props.substance!==o.substance||this.props.style!==o.style){await this.compile(),this.props.animate||await this.converge(),this.renderCanvas();return}if(this.penroseState&&!this.state.error){if(this.props.variation!==o.variation||this.props.animate!==o.animate){this.penroseState.variation=this.props.variation,this.penroseState=te(this.penroseState),this.props.animate||await this.converge(),this.renderCanvas();return}else if(this.props.interactive!==o.interactive){this.renderCanvas();return}}};componentWillUnmount=()=>{clearInterval(this.timerID)};renderCanvas=async()=>{if(this.canvasRef.current===null)return L("div",{children:"rendering..."});{const o=this.canvasRef.current;if(this.penroseState){const r=await(this.props.interactive===!1?Zt(this.penroseState,this.props.imageResolver??J,this.props.name??""):Kt(this.penroseState,async e=>{this.penroseState=e,this.props.animate||await this.converge(),this.renderCanvas()},this.props.imageResolver??J,this.props.name??""));r.setAttribute("height","100%"),r.setAttribute("width","100%"),o.firstChild!==null?o.replaceChild(r,o.firstChild):o.appendChild(r),this.props.onFrame&&this.props.onFrame(this.penroseState)}else return L("div",{children:"rendering..."})}};render=()=>{const{error:o}=this.state;return U("div",{style:{width:"100%",height:"100%"},children:[!o&&L("div",{style:{width:"100%",height:"100%"},ref:this.canvasRef}),o&&U("div",{style:{padding:"1em",height:"100%"},children:[L("div",{style:{fontWeight:700},children:"1 error:"}),L("div",{style:{fontFamily:"monospace"},children:ot(o).toString().split(`
...
//# sourceMappingURL=Simple-905c8469.js.map
