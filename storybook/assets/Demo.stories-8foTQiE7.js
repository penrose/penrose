import{j as i}from"./jsx-runtime-CCjYJYRa.js";import{r as d}from"./index-uubelm5h.js";import{S as y,__tla as h}from"./Simple-DawFUjKL.js";import{v as a}from"./PenrosePrograms-C0plgonl.js";import{__tla as x}from"./svg-DPOln9Bx.js";import{__tla as b}from"./vector-wedge.substance-Cq2rfnVc.js";import{__tla as f}from"./iframe-D6Bj04cU.js";import"../sb-preview/runtime.js";let e,u,c,R=Promise.all([(()=>{try{return h}catch{}})(),(()=>{try{return x}catch{}})(),(()=>{try{return b}catch{}})(),(()=>{try{return f}catch{}})()]).then(async()=>{var o,m,l;const s=t=>{const[p,g]=d.useState(0);d.useEffect(()=>{const v=window.setInterval(()=>g(_=>(_+1)%t.examples.length),5e3);return()=>clearInterval(v)},[p]);const r=t.examples[p];return i.jsx(y,{name:"demo",substance:r.sub,style:r.sty,domain:r.dsl,variation:r.variation,interactive:!1,animate:!0,stepSize:r.stepSize,imageResolver:r.imageResolver,excludeWarnings:[]})};s.__docgenInfo={description:"",methods:[],displayName:"Demo",props:{examples:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  sub: string;
  sty: string;
  dsl: string;
  variation: string;
