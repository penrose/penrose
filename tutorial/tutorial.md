...
* **_Have a (mental) list of the objects you want to include in the diagram_**
    ...
    * They are the :small_blue_diamond: **substances** of our diagram that we will see. 
...
* **_Explore different visual styles_**
    * Drawings commonly require explorations and various attempts with colors, sizes, and compositions. The same concept can be visualized in a number of different :small_blue_diamond: **styles**. 
