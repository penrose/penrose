...
Now we are going to spend some time going over the starter code. There are comments in the starter code that documents each block briefly. Read along for more in-depth explanations. 
